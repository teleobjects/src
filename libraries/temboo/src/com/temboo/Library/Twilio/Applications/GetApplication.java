...
*/
public class GetApplication extends Choreography {

	/**
	Create a new instance of the GetApplication Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetApplication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Applications/GetApplication"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetApplicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetApplicationResultSet(result);
	}
