...
public class DeleteApplication extends Choreography {
	...
	*/
	public DeleteApplication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Applications/DeleteApplication"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteApplicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteApplicationResultSet(result);
	}
