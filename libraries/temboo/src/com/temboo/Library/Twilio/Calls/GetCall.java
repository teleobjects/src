...
*/
public class GetCall extends Choreography {

	/**
	Create a new instance of the GetCall Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCall(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Calls/GetCall"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCallResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCallResultSet(result);
	}
