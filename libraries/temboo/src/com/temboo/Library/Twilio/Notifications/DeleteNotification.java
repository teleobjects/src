...
*/
public class DeleteNotification extends Choreography {

	/**
	Create a new instance of the DeleteNotification Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteNotification(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Notifications/DeleteNotification"));
	}
	...
	*/
	public void setNotificationSID(String value) {
		this.inputs.setInput("NotificationSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteNotificationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteNotificationResultSet(result);
	}
