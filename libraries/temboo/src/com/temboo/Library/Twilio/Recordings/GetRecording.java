...
*/
public class GetRecording extends Choreography {

	/**
	Create a new instance of the GetRecording Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRecording(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Recordings/GetRecording"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRecordingResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecordingResultSet(result);
	}
