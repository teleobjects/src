...
*/
public class DeleteRecording extends Choreography {

	/**
	Create a new instance of the DeleteRecording Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRecording(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Recordings/DeleteRecording"));
	}
	...
	*/
	public void setRecordingSID(String value) {
		this.inputs.setInput("RecordingSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRecordingResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRecordingResultSet(result);
	}
