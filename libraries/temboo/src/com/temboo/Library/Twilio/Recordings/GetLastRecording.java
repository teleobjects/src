...
*/
public class GetLastRecording extends Choreography {

	/**
	Create a new instance of the GetLastRecording Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLastRecording(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Recordings/GetLastRecording"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLastRecordingResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLastRecordingResultSet(result);
	}
