...
*/
public class GetMessage extends Choreography {

	/**
	Create a new instance of the GetMessage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/SMSMessages/GetMessage"));
	}
	...
	*/
	public void setSMSMessageSID(String value) {
		this.inputs.setInput("SMSMessageSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMessageResultSet(result);
	}
