...
*/
public class GetConference extends Choreography {

	/**
	Create a new instance of the GetConference Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetConference(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Conferences/GetConference"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetConferenceResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetConferenceResultSet(result);
	}
