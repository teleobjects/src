...
*/
public class GetParticipant extends Choreography {

	/**
	Create a new instance of the GetParticipant Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetParticipant(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Conferences/GetParticipant"));
	}
	...
	*/
	public void setConferencesSID(String value) {
		this.inputs.setInput("ConferencesSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetParticipantResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetParticipantResultSet(result);
	}
