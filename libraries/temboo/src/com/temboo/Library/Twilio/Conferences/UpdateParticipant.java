...
*/
public class UpdateParticipant extends Choreography {

	/**
	Create a new instance of the UpdateParticipant Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateParticipant(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Conferences/UpdateParticipant"));
	}
	...
	*/
	public void setMuted(String value) {
		this.inputs.setInput("Muted", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateParticipantResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateParticipantResultSet(result);
	}
