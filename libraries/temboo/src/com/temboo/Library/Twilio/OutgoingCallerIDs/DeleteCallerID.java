...
*/
public class DeleteCallerID extends Choreography {

	/**
	Create a new instance of the DeleteCallerID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteCallerID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/OutgoingCallerIDs/DeleteCallerID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteCallerIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteCallerIDResultSet(result);
	}
