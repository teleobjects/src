...
*/
public class GetCallerID extends Choreography {

	/**
	Create a new instance of the GetCallerID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCallerID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/OutgoingCallerIDs/GetCallerID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCallerIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCallerIDResultSet(result);
	}
