...
*/
public class DeletePhoneNumber extends Choreography {

	/**
	Create a new instance of the DeletePhoneNumber Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeletePhoneNumber(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/IncomingPhoneNumbers/DeletePhoneNumber"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeletePhoneNumberResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeletePhoneNumberResultSet(result);
	}
