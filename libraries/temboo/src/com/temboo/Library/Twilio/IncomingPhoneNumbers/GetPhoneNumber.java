...
*/
public class GetPhoneNumber extends Choreography {

	/**
	Create a new instance of the GetPhoneNumber Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPhoneNumber(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/IncomingPhoneNumbers/GetPhoneNumber"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPhoneNumberResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPhoneNumberResultSet(result);
	}
