...
*/
public class FilterPlacesByCity extends Choreography {

	/**
	Create a new instance of the FilterPlacesByCity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FilterPlacesByCity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Factual/FilterPlacesByCity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FilterPlacesByCityResultSet run() {
		JSONObject result = super.runWithResults();
		return new FilterPlacesByCityResultSet(result);
	}
