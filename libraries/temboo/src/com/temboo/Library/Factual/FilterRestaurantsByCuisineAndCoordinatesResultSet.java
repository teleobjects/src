...
*/
public  class FilterRestaurantsByCuisineAndCoordinatesResultSet extends ResultSet {
		
	public FilterRestaurantsByCuisineAndCoordinatesResultSet(JSONObject doc) {
		super(doc);
	}
