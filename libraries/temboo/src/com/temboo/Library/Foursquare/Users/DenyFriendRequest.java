...
*/
public class DenyFriendRequest extends Choreography {

	/**
	Create a new instance of the DenyFriendRequest Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DenyFriendRequest(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Users/DenyFriendRequest"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DenyFriendRequestResultSet run() {
		JSONObject result = super.runWithResults();
		return new DenyFriendRequestResultSet(result);
	}
