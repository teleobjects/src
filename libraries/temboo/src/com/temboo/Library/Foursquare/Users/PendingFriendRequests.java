...
*/
public class PendingFriendRequests extends Choreography {

	/**
	Create a new instance of the PendingFriendRequests Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PendingFriendRequests(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Users/PendingFriendRequests"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PendingFriendRequestsResultSet run() {
		JSONObject result = super.runWithResults();
		return new PendingFriendRequestsResultSet(result);
	}
