...
*/
public class Mayorships extends Choreography {

	/**
	Create a new instance of the Mayorships Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Mayorships(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Users/Mayorships"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MayorshipsResultSet run() {
		JSONObject result = super.runWithResults();
		return new MayorshipsResultSet(result);
	}
