...
*/
public class Unfriend extends Choreography {

	/**
	Create a new instance of the Unfriend Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Unfriend(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Users/Unfriend"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of a user to unfriend.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnfriendResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnfriendResultSet(result);
	}
