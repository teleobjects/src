...
public class Badges extends Choreography {
	...
	*/
	public Badges(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Users/Badges"));
	}
	...
	*/
	 ...
	 */
	@Override
	public BadgesResultSet run() {
		JSONObject result = super.runWithResults();
		return new BadgesResultSet(result);
	}
