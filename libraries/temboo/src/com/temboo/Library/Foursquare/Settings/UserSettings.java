...
*/
public class UserSettings extends Choreography {

	/**
	Create a new instance of the UserSettings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UserSettings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Settings/UserSettings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UserSettingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new UserSettingsResultSet(result);
	}
