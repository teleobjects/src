...
*/
public class VenueHours extends Choreography {

	/**
	Create a new instance of the VenueHours Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VenueHours(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Venues/VenueHours"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the venue to retrieve hours for.
	*/
	 ...
	 */
	@Override
	public VenueHoursResultSet run() {
		JSONObject result = super.runWithResults();
		return new VenueHoursResultSet(result);
	}
