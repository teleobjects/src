...
*/
public class NextVenue extends Choreography {

	/**
	Create a new instance of the NextVenue Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public NextVenue(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Venues/NextVenue"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the venue you want to see next venue information about.
	*/
	 ...
	 */
	@Override
	public NextVenueResultSet run() {
		JSONObject result = super.runWithResults();
		return new NextVenueResultSet(result);
	}
