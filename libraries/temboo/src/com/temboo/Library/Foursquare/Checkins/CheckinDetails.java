...
*/
public class CheckinDetails extends Choreography {

	/**
	Create a new instance of the CheckinDetails Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CheckinDetails(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Checkins/CheckinDetails"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CheckinDetailsResultSet run() {
		JSONObject result = super.runWithResults();
		return new CheckinDetailsResultSet(result);
	}
