...
public class FollowList extends Choreography {
	...
	*/
	public FollowList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Foursquare/Lists/FollowList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FollowListResultSet run() {
		JSONObject result = super.runWithResults();
		return new FollowListResultSet(result);
	}
