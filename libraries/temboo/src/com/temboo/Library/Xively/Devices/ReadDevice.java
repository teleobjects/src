...
*/
public class ReadDevice extends Choreography {

	/**
	Create a new instance of the ReadDevice Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadDevice(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Xively/Devices/ReadDevice"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadDeviceResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadDeviceResultSet(result);
	}
