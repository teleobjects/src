...
*/
public  class DeleteMultipleDatapointsResultSet extends ResultSet {
		
	public DeleteMultipleDatapointsResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getResponsStatusCode() {
		return this.getResultString("ResponsStatusCode");
	}
}