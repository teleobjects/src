...
*/
public  class CreateProductResultSet extends ResultSet {
		
	public CreateProductResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getProductID() {
		return this.getResultString("ProductID");
	}
	/** 
	...
	*/
	public String getProductLocation() {
		return this.getResultString("ProductLocation");
	}
	/** 
