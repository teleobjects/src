...
*/
public class ListAllProducts extends Choreography {

	/**
	Create a new instance of the ListAllProducts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllProducts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Xively/Products/ListAllProducts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllProductsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllProductsResultSet(result);
	}
