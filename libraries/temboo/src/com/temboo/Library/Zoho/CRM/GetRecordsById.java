...
public class GetRecordsById extends Choreography {
	...
	*/
	public GetRecordsById(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/CRM/GetRecordsById"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the Zoho record to lookup
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetRecordsByIdResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecordsByIdResultSet(result);
	}
