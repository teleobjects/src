...
*/
public class GetMyRecords extends Choreography {

	/**
	Create a new instance of the GetMyRecords Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMyRecords(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/CRM/GetMyRecords"));
	}
	...
	*/
	public void setSortColumnString(Integer value) {
		this.inputs.setInput("SortColumnString", value);
	}

	/** 
	Set the value of the SortColumnString input for this Choreo as a String. 

	@param String - (optional, integer) Used to specify a column to sort by
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetMyRecordsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMyRecordsResultSet(result);
	}
