...
public class InitializeOAuth extends Choreography {
	...
	*/
	public InitializeOAuth(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/LoginWithAmazon/InitializeOAuth"));
	}
	...
	*/
	...
	@param String - (conditional, string) A space-delimited list of permissions to request access for (e.g., clouddrive:read clouddrive:write).
	*/
