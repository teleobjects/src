...
*/
public class DeleteDBInstance extends Choreography {

	/**
	Create a new instance of the DeleteDBInstance Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteDBInstance(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/DeleteDBInstance"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteDBInstanceResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteDBInstanceResultSet(result);
	}
