...
*/
public class CreateDBSecurityGroup extends Choreography {

	/**
	Create a new instance of the CreateDBSecurityGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateDBSecurityGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/CreateDBSecurityGroup"));
	}
	...
	*/
	public void setDBSecurityGroupDescription(String value) {
		this.inputs.setInput("DBSecurityGroupDescription", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateDBSecurityGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateDBSecurityGroupResultSet(result);
	}
