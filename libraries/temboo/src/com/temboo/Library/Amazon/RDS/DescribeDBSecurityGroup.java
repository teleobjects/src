...
*/
public class DescribeDBSecurityGroup extends Choreography {

	/**
	Create a new instance of the DescribeDBSecurityGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeDBSecurityGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/DescribeDBSecurityGroup"));
	}
	...
	*/
	...
	@param String - (optional, integer) The max number of results to return in the response. Defaults to 100. Minimum is 20.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DescribeDBSecurityGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeDBSecurityGroupResultSet(result);
	}
