...
*/
public class RebootDBInstance extends Choreography {

	/**
	Create a new instance of the RebootDBInstance Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RebootDBInstance(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/RebootDBInstance"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RebootDBInstanceResultSet run() {
		JSONObject result = super.runWithResults();
		return new RebootDBInstanceResultSet(result);
	}
