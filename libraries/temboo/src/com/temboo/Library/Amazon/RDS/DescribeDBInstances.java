...
*/
public class DescribeDBInstances extends Choreography {

	/**
	Create a new instance of the DescribeDBInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeDBInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/DescribeDBInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeDBInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeDBInstancesResultSet(result);
	}
