...
*/
public class DeleteDBSnapshot extends Choreography {

	/**
	Create a new instance of the DeleteDBSnapshot Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteDBSnapshot(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/DeleteDBSnapshot"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteDBSnapshotResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteDBSnapshotResultSet(result);
	}
