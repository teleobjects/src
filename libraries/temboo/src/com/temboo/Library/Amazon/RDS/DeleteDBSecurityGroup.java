...
public class DeleteDBSecurityGroup extends Choreography {
	...
	*/
	public DeleteDBSecurityGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/RDS/DeleteDBSecurityGroup"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteDBSecurityGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteDBSecurityGroupResultSet(result);
	}
