...
*/
public class DeleteServerCertificate extends Choreography {

	/**
	Create a new instance of the DeleteServerCertificate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteServerCertificate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteServerCertificate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteServerCertificateResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteServerCertificateResultSet(result);
	}
