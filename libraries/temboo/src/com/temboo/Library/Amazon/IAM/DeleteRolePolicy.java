...
*/
public class DeleteRolePolicy extends Choreography {

	/**
	Create a new instance of the DeleteRolePolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRolePolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteRolePolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRolePolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRolePolicyResultSet(result);
	}
