...
*/
public class DeleteGroupPolicy extends Choreography {

	/**
	Create a new instance of the DeleteGroupPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteGroupPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteGroupPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteGroupPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteGroupPolicyResultSet(result);
	}
