...
*/
public class CreateAccessKey extends Choreography {

	/**
	Create a new instance of the CreateAccessKey Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateAccessKey(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/CreateAccessKey"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateAccessKeyResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateAccessKeyResultSet(result);
	}
