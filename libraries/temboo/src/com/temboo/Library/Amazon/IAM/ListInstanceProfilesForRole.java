...
*/
public class ListInstanceProfilesForRole extends Choreography {

	/**
	Create a new instance of the ListInstanceProfilesForRole Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListInstanceProfilesForRole(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListInstanceProfilesForRole"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListInstanceProfilesForRoleResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListInstanceProfilesForRoleResultSet(result);
	}
