...
*/
public class ListSigningCertificates extends Choreography {

	/**
	Create a new instance of the ListSigningCertificates Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSigningCertificates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListSigningCertificates"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSigningCertificatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSigningCertificatesResultSet(result);
	}
