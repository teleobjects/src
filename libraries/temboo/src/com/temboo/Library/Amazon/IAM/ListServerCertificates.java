...
*/
public class ListServerCertificates extends Choreography {

	/**
	Create a new instance of the ListServerCertificates Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListServerCertificates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListServerCertificates"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListServerCertificatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListServerCertificatesResultSet(result);
	}
