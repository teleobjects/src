...
*/
public class ListGroupPolicies extends Choreography {

	/**
	Create a new instance of the ListGroupPolicies Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGroupPolicies(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListGroupPolicies"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGroupPoliciesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGroupPoliciesResultSet(result);
	}
