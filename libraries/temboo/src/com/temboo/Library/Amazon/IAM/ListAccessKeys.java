...
*/
public class ListAccessKeys extends Choreography {

	/**
	Create a new instance of the ListAccessKeys Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAccessKeys(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListAccessKeys"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAccessKeysResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAccessKeysResultSet(result);
	}
