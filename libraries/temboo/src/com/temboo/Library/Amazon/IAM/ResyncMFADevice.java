...
*/
public class ResyncMFADevice extends Choreography {

	/**
	Create a new instance of the ResyncMFADevice Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ResyncMFADevice(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ResyncMFADevice"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ResyncMFADeviceResultSet run() {
		JSONObject result = super.runWithResults();
		return new ResyncMFADeviceResultSet(result);
	}
