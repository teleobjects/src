...
public class UpdateGroup extends Choreography {
	...
	*/
	public UpdateGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/UpdateGroup"));
	}
	...
	*/
	public void setNewGroupName(String value) {
		this.inputs.setInput("NewGroupName", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateGroupResultSet run() {
