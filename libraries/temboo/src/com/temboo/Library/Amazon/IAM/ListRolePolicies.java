...
*/
public class ListRolePolicies extends Choreography {

	/**
	Create a new instance of the ListRolePolicies Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRolePolicies(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListRolePolicies"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRolePoliciesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRolePoliciesResultSet(result);
	}
