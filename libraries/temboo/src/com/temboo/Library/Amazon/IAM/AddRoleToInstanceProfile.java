...
*/
public class AddRoleToInstanceProfile extends Choreography {

	/**
	Create a new instance of the AddRoleToInstanceProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddRoleToInstanceProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/AddRoleToInstanceProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AddRoleToInstanceProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddRoleToInstanceProfileResultSet(result);
	}
