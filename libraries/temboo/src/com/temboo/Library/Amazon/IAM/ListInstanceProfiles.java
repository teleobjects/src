...
*/
public class ListInstanceProfiles extends Choreography {

	/**
	Create a new instance of the ListInstanceProfiles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListInstanceProfiles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListInstanceProfiles"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListInstanceProfilesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListInstanceProfilesResultSet(result);
	}
