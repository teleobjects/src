...
*/
public class ListGroupsForUser extends Choreography {

	/**
	Create a new instance of the ListGroupsForUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGroupsForUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListGroupsForUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGroupsForUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGroupsForUserResultSet(result);
	}
