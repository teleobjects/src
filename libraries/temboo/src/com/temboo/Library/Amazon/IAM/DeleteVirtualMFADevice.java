...
*/
public class DeleteVirtualMFADevice extends Choreography {

	/**
	Create a new instance of the DeleteVirtualMFADevice Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteVirtualMFADevice(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteVirtualMFADevice"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteVirtualMFADeviceResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteVirtualMFADeviceResultSet(result);
	}
