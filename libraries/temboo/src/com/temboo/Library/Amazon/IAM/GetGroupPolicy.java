...
*/
public class GetGroupPolicy extends Choreography {

	/**
	Create a new instance of the GetGroupPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetGroupPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/GetGroupPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetGroupPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetGroupPolicyResultSet(result);
	}
