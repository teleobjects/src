...
*/
public class GetLoginProfile extends Choreography {

	/**
	Create a new instance of the GetLoginProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLoginProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/GetLoginProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLoginProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLoginProfileResultSet(result);
	}
