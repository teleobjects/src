...
*/
public class GetServerCertificate extends Choreography {

	/**
	Create a new instance of the GetServerCertificate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetServerCertificate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/GetServerCertificate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetServerCertificateResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetServerCertificateResultSet(result);
	}
