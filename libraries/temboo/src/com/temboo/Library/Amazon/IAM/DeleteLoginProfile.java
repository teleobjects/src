...
*/
public class DeleteLoginProfile extends Choreography {

	/**
	Create a new instance of the DeleteLoginProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteLoginProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteLoginProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteLoginProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteLoginProfileResultSet(result);
	}
