...
*/
public class CreateInstanceProfile extends Choreography {

	/**
	Create a new instance of the CreateInstanceProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateInstanceProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/CreateInstanceProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateInstanceProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateInstanceProfileResultSet(result);
	}
