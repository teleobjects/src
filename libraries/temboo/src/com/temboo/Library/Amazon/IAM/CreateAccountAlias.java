...
*/
public class CreateAccountAlias extends Choreography {

	/**
	Create a new instance of the CreateAccountAlias Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateAccountAlias(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/CreateAccountAlias"));
	}
	...
	*/
	public void setAccountAlias(String value) {
		this.inputs.setInput("AccountAlias", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateAccountAliasResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateAccountAliasResultSet(result);
	}
