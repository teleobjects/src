...
*/
public class UploadSigningCertificate extends Choreography {

	/**
	Create a new instance of the UploadSigningCertificate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UploadSigningCertificate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/UploadSigningCertificate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UploadSigningCertificateResultSet run() {
		JSONObject result = super.runWithResults();
		return new UploadSigningCertificateResultSet(result);
	}
