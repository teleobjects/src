...
*/
public class UpdateLoginProfile extends Choreography {

	/**
	Create a new instance of the UpdateLoginProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateLoginProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/UpdateLoginProfile"));
	}
	...
	*/
	...
	@param String - (optional, boolean) Specifies whether or not the user should be required to change their password immediately.  Valid values are true/false or 1/0.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UpdateLoginProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateLoginProfileResultSet(result);
	}
