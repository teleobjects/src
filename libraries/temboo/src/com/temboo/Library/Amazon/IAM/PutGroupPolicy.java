...
*/
public class PutGroupPolicy extends Choreography {

	/**
	Create a new instance of the PutGroupPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PutGroupPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/PutGroupPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PutGroupPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new PutGroupPolicyResultSet(result);
	}
