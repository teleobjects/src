...
*/
public class DeleteUserPolicy extends Choreography {

	/**
	Create a new instance of the DeleteUserPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteUserPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteUserPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteUserPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteUserPolicyResultSet(result);
	}
