...
*/
public class DeleteAccountAlias extends Choreography {

	/**
	Create a new instance of the DeleteAccountAlias Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteAccountAlias(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteAccountAlias"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteAccountAliasResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteAccountAliasResultSet(result);
	}
