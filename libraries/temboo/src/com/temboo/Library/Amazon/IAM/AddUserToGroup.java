...
*/
public class AddUserToGroup extends Choreography {

	/**
	Create a new instance of the AddUserToGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddUserToGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/AddUserToGroup"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AddUserToGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddUserToGroupResultSet(result);
	}
