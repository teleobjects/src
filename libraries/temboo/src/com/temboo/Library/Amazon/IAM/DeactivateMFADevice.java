...
*/
public class DeactivateMFADevice extends Choreography {

	/**
	Create a new instance of the DeactivateMFADevice Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeactivateMFADevice(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeactivateMFADevice"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeactivateMFADeviceResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeactivateMFADeviceResultSet(result);
	}
