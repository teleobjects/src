...
*/
public class DeleteInstanceProfile extends Choreography {

	/**
	Create a new instance of the DeleteInstanceProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteInstanceProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/DeleteInstanceProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteInstanceProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteInstanceProfileResultSet(result);
	}
