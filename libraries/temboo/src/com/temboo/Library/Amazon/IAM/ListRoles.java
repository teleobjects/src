...
*/
public class ListRoles extends Choreography {

	/**
	Create a new instance of the ListRoles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRoles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListRoles"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRolesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRolesResultSet(result);
	}
