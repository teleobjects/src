...
*/
public class ListAccountAliases extends Choreography {

	/**
	Create a new instance of the ListAccountAliases Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAccountAliases(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/ListAccountAliases"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAccountAliasesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAccountAliasesResultSet(result);
	}
