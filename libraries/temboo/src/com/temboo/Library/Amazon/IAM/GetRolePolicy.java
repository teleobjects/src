...
*/
public class GetRolePolicy extends Choreography {

	/**
	Create a new instance of the GetRolePolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRolePolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/GetRolePolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRolePolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRolePolicyResultSet(result);
	}
