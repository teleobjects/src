...
*/
public class GetUserPolicy extends Choreography {

	/**
	Create a new instance of the GetUserPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUserPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/GetUserPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUserPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUserPolicyResultSet(result);
	}
