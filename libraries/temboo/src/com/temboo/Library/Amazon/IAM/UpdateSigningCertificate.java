...
*/
public class UpdateSigningCertificate extends Choreography {

	/**
	Create a new instance of the UpdateSigningCertificate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateSigningCertificate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/IAM/UpdateSigningCertificate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateSigningCertificateResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateSigningCertificateResultSet(result);
	}
