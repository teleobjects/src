...
public class SendMessage extends Choreography {
	...
	*/
	...
	/** 
	Set the value of the DelaySeconds input for this Choreo. 

	@param String - (optional, string) The number of seconds (0 to 900 - 15 minutes) to delay a specific message.
	*/
	public void setDelaySeconds(String value) {
		this.inputs.setInput("DelaySeconds", value);
	}


	/** 
	Set the value of the MessageAttributes input for this Choreo. 

	@param String - (optional, json) A JSON array of message attributes. See Choreo notes for formatting details.
	*/
	public void setMessageAttributes(String value) {
		this.inputs.setInput("MessageAttributes", value);
	}
