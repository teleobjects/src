...
*/
public class DeleteTable extends Choreography {

	/**
	Create a new instance of the DeleteTable Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteTable(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/DynamoDB/DeleteTable"));
	}
	...
	*/
	...
	@param String - (required, string) The name of the table to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteTableResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteTableResultSet(result);
	}
