...
public class DeleteItem extends Choreography {
	...
	*/
	public DeleteItem(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/DynamoDB/DeleteItem"));
	}
	...
	*/
	...
	@param String - (optional, string) A condition that must be satisfied in order for a conditional DeleteItem to succeed.
	*/
	...
	*/
	...
	@param String - (required, json) A map of attribute names to AttributeValue objects, representing the primary key of the item to delete.
	*/
	...
	*/
	...
	@param String - (optional, string) Use ReturnValues if you want to get the item attributes as they appeared before they were deleted. Valid values are NONE and ALL_OLD.
	*/
	...
	@param String - (required, string) The name of the table from which to delete the item.
	*/
