...
*/
public class DescribeTable extends Choreography {

	/**
	Create a new instance of the DescribeTable Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeTable(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/DynamoDB/DescribeTable"));
	}
	...
	*/
	...
	@param String - (required, string) The name of the table to describe.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DescribeTableResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeTableResultSet(result);
	}
