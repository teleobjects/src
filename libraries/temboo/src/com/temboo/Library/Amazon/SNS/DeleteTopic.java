...
*/
public class DeleteTopic extends Choreography {

	/**
	Create a new instance of the DeleteTopic Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteTopic(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/DeleteTopic"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteTopicResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteTopicResultSet(result);
	}
