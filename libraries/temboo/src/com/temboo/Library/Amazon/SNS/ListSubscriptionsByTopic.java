...
*/
public class ListSubscriptionsByTopic extends Choreography {

	/**
	Create a new instance of the ListSubscriptionsByTopic Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSubscriptionsByTopic(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/ListSubscriptionsByTopic"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSubscriptionsByTopicResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSubscriptionsByTopicResultSet(result);
	}
