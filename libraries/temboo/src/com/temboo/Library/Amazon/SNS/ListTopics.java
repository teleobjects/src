...
*/
public class ListTopics extends Choreography {

	/**
	Create a new instance of the ListTopics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTopics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/ListTopics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListTopicsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTopicsResultSet(result);
	}
