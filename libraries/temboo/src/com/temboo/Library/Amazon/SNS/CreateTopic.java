...
*/
public class CreateTopic extends Choreography {

	/**
	Create a new instance of the CreateTopic Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateTopic(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/CreateTopic"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateTopicResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateTopicResultSet(result);
	}
