...
*/
public class GetTopicAttributes extends Choreography {

	/**
	Create a new instance of the GetTopicAttributes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTopicAttributes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/GetTopicAttributes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTopicAttributesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTopicAttributesResultSet(result);
	}
