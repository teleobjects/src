...
*/
public class Unsubscribe extends Choreography {

	/**
	Create a new instance of the Unsubscribe Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Unsubscribe(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SNS/Unsubscribe"));
	}
	...
	*/
	public void setSubscriptionArn(String value) {
		this.inputs.setInput("SubscriptionArn", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UnsubscribeResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnsubscribeResultSet(result);
	}
