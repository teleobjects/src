...
*/
public class AddChild extends Choreography {

	/**
	Create a new instance of the AddChild Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddChild(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Children/AddChild"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the folder that is being moved within a parent folder.
	*/
	...
	*/
	...
	@param String - (required, string) The ID of the parent folder that will contain the child folder that's being moved.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddChildResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddChildResultSet(result);
	}
