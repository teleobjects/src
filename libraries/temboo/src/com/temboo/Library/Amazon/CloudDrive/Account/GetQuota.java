...
*/
public class GetQuota extends Choreography {

	/**
	Create a new instance of the GetQuota Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetQuota(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Account/GetQuota"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetQuotaResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetQuotaResultSet(result);
	}
