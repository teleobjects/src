...
*/
public class GetStatistics extends Choreography {

	/**
	Create a new instance of the GetStatistics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetStatistics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetStatistics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetStatisticsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetStatisticsResultSet(result);
	}
