...
*/
public class GetHistoricalUpdates extends Choreography {

	/**
	Create a new instance of the GetHistoricalUpdates Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetHistoricalUpdates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetHistoricalUpdates"));
	}
	...
	*/
	...
	@param String - (optional, string) A comma separated list of additional fields to return.
	*/
	...
	*/
	...
	@param String - (optional, string) Optionally provide an update key value to return statistics for a specific company update.
	*/
	 ...
	 */
	@Override
	public GetHistoricalUpdatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetHistoricalUpdatesResultSet(result);
	}
