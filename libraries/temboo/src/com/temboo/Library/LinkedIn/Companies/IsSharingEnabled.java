...
*/
public class IsSharingEnabled extends Choreography {

	/**
	Create a new instance of the IsSharingEnabled Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public IsSharingEnabled(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/IsSharingEnabled"));
	}
	...
	*/
	 ...
	 */
	@Override
	public IsSharingEnabledResultSet run() {
		JSONObject result = super.runWithResults();
		return new IsSharingEnabledResultSet(result);
	}
