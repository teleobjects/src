...
*/
public class GetLikes extends Choreography {

	/**
	Create a new instance of the GetLikes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLikes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetLikes"));
	}
	...
	*/
	...
	@param String - (required, string) The key of the update to return likes for.
	*/
	 ...
	 */
	@Override
	public GetLikesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLikesResultSet(result);
	}
