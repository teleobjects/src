...
public class GetComments extends Choreography {
	...
	*/
	public GetComments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetComments"));
	}
	...
	*/
	...
	@param String - (required, string) The key of the update to retrieve comments for.
	*/
