...
*/
public class IsAdmin extends Choreography {

	/**
	Create a new instance of the IsAdmin Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public IsAdmin(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/IsAdmin"));
	}
	...
	*/
	 ...
	 */
	@Override
	public IsAdminResultSet run() {
		JSONObject result = super.runWithResults();
		return new IsAdminResultSet(result);
	}
