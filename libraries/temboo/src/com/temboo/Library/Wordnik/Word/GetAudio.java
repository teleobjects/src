...
*/
public class GetAudio extends Choreography {

	/**
	Create a new instance of the GetAudio Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAudio(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Word/GetAudio"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAudioResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAudioResultSet(result);
	}
