...
*/
public class GetTopExample extends Choreography {

	/**
	Create a new instance of the GetTopExample Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTopExample(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Word/GetTopExample"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTopExampleResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTopExampleResultSet(result);
	}
