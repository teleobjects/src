...
*/
public class GetEtymology extends Choreography {

	/**
	Create a new instance of the GetEtymology Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEtymology(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Word/GetEtymology"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetEtymologyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEtymologyResultSet(result);
	}
