...
*/
public class GetFrequency extends Choreography {

	/**
	Create a new instance of the GetFrequency Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFrequency(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Word/GetFrequency"));
	}
	...
	*/
	public void setEndYear(Integer value) {
		this.inputs.setInput("EndYear", value);
	}

	/** 
	Set the value of the EndYear input for this Choreo as a String. 

	@param String - (optional, integer) End year for which to return word use frequencies. Defaults to 2012.
	*/
	...
	*/
	public void setStartYear(Integer value) {
		this.inputs.setInput("StartYear", value);
	}

	/** 
	Set the value of the StartYear input for this Choreo as a String. 

	@param String - (optional, integer) Start year for which to return word use frequencies. Defaults to 1800.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetFrequencyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFrequencyResultSet(result);
	}
