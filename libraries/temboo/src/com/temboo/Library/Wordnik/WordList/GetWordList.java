...
*/
public class GetWordList extends Choreography {

	/**
	Create a new instance of the GetWordList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWordList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/WordList/GetWordList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWordListResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWordListResultSet(result);
	}
