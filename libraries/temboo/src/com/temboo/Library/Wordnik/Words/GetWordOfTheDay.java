...
*/
public class GetWordOfTheDay extends Choreography {

	/**
	Create a new instance of the GetWordOfTheDay Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWordOfTheDay(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Words/GetWordOfTheDay"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWordOfTheDayResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWordOfTheDayResultSet(result);
	}
