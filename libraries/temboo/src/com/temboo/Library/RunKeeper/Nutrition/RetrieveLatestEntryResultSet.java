...
public  class RetrieveLatestEntryResultSet extends ResultSet {
	...
	@return String - (integer) The number of calories associated with the latest nutrition entry.
	*/
	...
	*/
	public String getMeal() {
		return this.getResultString("Meal");
	}
	/** 
	...
	*/
	...
	@return String - (decimal) The water measurement from the latest nutrition entry.
	*/
	public String getWater() {
		return this.getResultString("Water");
	}
	/** 
