...
*/
public class GetDiscussion extends Choreography {

	/**
	Create a new instance of the GetDiscussion Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDiscussion(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Discussions/GetDiscussion"));
	}
	...
	*/
	public void setDiscussionID(String value) {
		this.inputs.setInput("DiscussionID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetDiscussionResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDiscussionResultSet(result);
	}
