...
*/
public class GetPendingCollaborations extends Choreography {

	/**
	Create a new instance of the GetPendingCollaborations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPendingCollaborations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Collaborations/GetPendingCollaborations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPendingCollaborationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPendingCollaborationsResultSet(result);
	}
