...
*/
public class UpdateComment extends Choreography {

	/**
	Create a new instance of the UpdateComment Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateComment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Comments/UpdateComment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateCommentResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateCommentResultSet(result);
	}
