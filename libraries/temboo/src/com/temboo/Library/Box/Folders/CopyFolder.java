...
*/
public class CopyFolder extends Choreography {

	/**
	Create a new instance of the CopyFolder Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CopyFolder(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Folders/CopyFolder"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CopyFolderResultSet run() {
		JSONObject result = super.runWithResults();
		return new CopyFolderResultSet(result);
	}
