...
*/
public class GetFolderInformation extends Choreography {

	/**
	Create a new instance of the GetFolderInformation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFolderInformation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Folders/GetFolderInformation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFolderInformationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFolderInformationResultSet(result);
	}
