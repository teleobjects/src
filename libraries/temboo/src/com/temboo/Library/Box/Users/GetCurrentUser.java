...
*/
public class GetCurrentUser extends Choreography {

	/**
	Create a new instance of the GetCurrentUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCurrentUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Users/GetCurrentUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCurrentUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCurrentUserResultSet(result);
	}
