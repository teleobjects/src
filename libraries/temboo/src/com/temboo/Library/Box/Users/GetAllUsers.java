...
*/
public class GetAllUsers extends Choreography {

	/**
	Create a new instance of the GetAllUsers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllUsers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Box/Users/GetAllUsers"));
	}
	...
	*/
	...
	/** 
	Set the value of the FilterTerm input for this Choreo. 

	@param String - (optional, string) A string used to filter the results to only users starting with the filter_term in either the name or the login.
	*/
	public void setFilterTerm(String value) {
		this.inputs.setInput("FilterTerm", value);
	}
	...
	@param Integer - (optional, integer) The number of records to return.
	*/
	...
	@param String - (optional, integer) The number of records to return.
	*/
	...
	@param Integer - (optional, integer) The record at which to start. Defaults to 0.
	*/
	...
	@param String - (optional, integer) The record at which to start. Defaults to 0.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetAllUsersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllUsersResultSet(result);
	}
