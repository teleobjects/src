...
*/
public class LookupSale extends Choreography {

	/**
	Create a new instance of the LookupSale Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LookupSale(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PayPal/SaleTransactions/LookupSale"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LookupSaleResultSet run() {
		JSONObject result = super.runWithResults();
		return new LookupSaleResultSet(result);
	}
