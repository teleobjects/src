...
*/
public class GetLatestPayment extends Choreography {

	/**
	Create a new instance of the GetLatestPayment Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLatestPayment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PayPal/Payments/GetLatestPayment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLatestPaymentResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLatestPaymentResultSet(result);
	}
