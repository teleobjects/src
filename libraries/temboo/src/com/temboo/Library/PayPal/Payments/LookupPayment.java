...
public class LookupPayment extends Choreography {
	...
	*/
	public LookupPayment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PayPal/Payments/LookupPayment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LookupPaymentResultSet run() {
		JSONObject result = super.runWithResults();
		return new LookupPaymentResultSet(result);
	}
