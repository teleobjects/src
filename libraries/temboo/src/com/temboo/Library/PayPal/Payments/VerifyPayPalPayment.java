...
*/
public class VerifyPayPalPayment extends Choreography {

	/**
	Create a new instance of the VerifyPayPalPayment Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VerifyPayPalPayment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PayPal/Payments/VerifyPayPalPayment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public VerifyPayPalPaymentResultSet run() {
		JSONObject result = super.runWithResults();
		return new VerifyPayPalPaymentResultSet(result);
	}
