...
public class HourlyUVByCity extends Choreography {
	...
	*/
	public HourlyUVByCity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/EnviroFacts/UVForecast/HourlyUVByCity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HourlyUVByCityResultSet run() {
		JSONObject result = super.runWithResults();
		return new HourlyUVByCityResultSet(result);
	}
