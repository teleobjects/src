...
*/
public class ToxinReleaseByFacility extends Choreography {

	/**
	Create a new instance of the ToxinReleaseByFacility Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ToxinReleaseByFacility(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/EnviroFacts/Toxins/ToxinReleaseByFacility"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ToxinReleaseByFacilityResultSet run() {
		JSONObject result = super.runWithResults();
		return new ToxinReleaseByFacilityResultSet(result);
	}
