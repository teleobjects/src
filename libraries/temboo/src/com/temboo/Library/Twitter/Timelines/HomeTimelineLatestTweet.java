...
public class HomeTimelineLatestTweet extends Choreography {
	...
	*/
	public HomeTimelineLatestTweet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Timelines/HomeTimelineLatestTweet"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HomeTimelineLatestTweetResultSet run() {
		JSONObject result = super.runWithResults();
		return new HomeTimelineLatestTweetResultSet(result);
	}
