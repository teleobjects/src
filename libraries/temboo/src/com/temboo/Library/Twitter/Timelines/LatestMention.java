...
*/
public class LatestMention extends Choreography {

	/**
	Create a new instance of the LatestMention Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LatestMention(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Timelines/LatestMention"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LatestMentionResultSet run() {
		JSONObject result = super.runWithResults();
		return new LatestMentionResultSet(result);
	}
