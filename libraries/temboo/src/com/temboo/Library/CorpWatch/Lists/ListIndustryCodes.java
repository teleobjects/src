...
*/
public class ListIndustryCodes extends Choreography {

	/**
	Create a new instance of the ListIndustryCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListIndustryCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CorpWatch/Lists/ListIndustryCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListIndustryCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListIndustryCodesResultSet(result);
	}
