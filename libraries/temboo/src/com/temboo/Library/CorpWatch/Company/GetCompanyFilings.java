...
*/
public class GetCompanyFilings extends Choreography {

	/**
	Create a new instance of the GetCompanyFilings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCompanyFilings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CorpWatch/Company/GetCompanyFilings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCompanyFilingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCompanyFilingsResultSet(result);
	}
