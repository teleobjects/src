...
*/
public class GetCompanyNames extends Choreography {

	/**
	Create a new instance of the GetCompanyNames Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCompanyNames(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CorpWatch/Company/GetCompanyNames"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCompanyNamesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCompanyNamesResultSet(result);
	}
