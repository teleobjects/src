...
*/
public class TopParent extends Choreography {

	/**
	Create a new instance of the TopParent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TopParent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CorpWatch/Relationships/TopParent"));
	}
	...
	*/
	...
	@param String - (optional, integer) If a year is specified, only subsidiaries for that year will be returned and the data in the company objects returned will be set appropriately for the request year. Defaults to most recent.
	*/
	 ...
	 */
	@Override
	public TopParentResultSet run() {
		JSONObject result = super.runWithResults();
		return new TopParentResultSet(result);
	}
