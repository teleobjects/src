...
*/
public class CompanyChildren extends Choreography {

	/**
	Create a new instance of the CompanyChildren Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CompanyChildren(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CorpWatch/Relationships/CompanyChildren"));
	}
	...
	*/
	...
	@param String - (conditional, integer) If a year is specified, only subsidiaries for that year will be returned and the data in the company objects returned will be set appropriately for the request year. Defaults to 2012 (most recent yr).
	*/
	 ...
	 */
	@Override
	public CompanyChildrenResultSet run() {
		JSONObject result = super.runWithResults();
		return new CompanyChildrenResultSet(result);
	}
