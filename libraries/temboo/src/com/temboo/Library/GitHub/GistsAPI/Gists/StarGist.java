...
*/
public class StarGist extends Choreography {

	/**
	Create a new instance of the StarGist Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public StarGist(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GistsAPI/Gists/StarGist"));
	}
	...
	*/
	 ...
	 */
	@Override
	public StarGistResultSet run() {
		JSONObject result = super.runWithResults();
		return new StarGistResultSet(result);
	}
