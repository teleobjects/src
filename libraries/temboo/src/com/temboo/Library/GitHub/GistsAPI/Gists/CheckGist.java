...
*/
public class CheckGist extends Choreography {

	/**
	Create a new instance of the CheckGist Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CheckGist(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GistsAPI/Gists/CheckGist"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CheckGistResultSet run() {
		JSONObject result = super.runWithResults();
		return new CheckGistResultSet(result);
	}
