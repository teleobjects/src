...
*/
public class GetLatestActivity extends Choreography {

	/**
	Create a new instance of the GetLatestActivity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLatestActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetLatestActivity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLatestActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLatestActivityResultSet(result);
	}
