...
*/
public class GetLatestFood extends Choreography {

	/**
	Create a new instance of the GetLatestFood Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLatestFood(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetLatestFood"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLatestFoodResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLatestFoodResultSet(result);
	}
