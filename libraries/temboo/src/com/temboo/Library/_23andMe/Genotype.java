...
*/
public class Genotype extends Choreography {

	/**
	Create a new instance of the Genotype Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Genotype(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/23andMe/Genotype"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GenotypeResultSet run() {
		JSONObject result = super.runWithResults();
		return new GenotypeResultSet(result);
	}
