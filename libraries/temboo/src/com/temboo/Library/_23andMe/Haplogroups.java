...
*/
public class Haplogroups extends Choreography {

	/**
	Create a new instance of the Haplogroups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Haplogroups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/23andMe/Haplogroups"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HaplogroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new HaplogroupsResultSet(result);
	}
