...
*/
public class Authenticate extends Choreography {

	/**
	Create a new instance of the Authenticate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Authenticate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instapaper/Authenticate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AuthenticateResultSet run() {
		JSONObject result = super.runWithResults();
		return new AuthenticateResultSet(result);
	}
