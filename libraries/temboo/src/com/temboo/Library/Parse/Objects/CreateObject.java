...
public class CreateObject extends Choreography {
	...
	*/
	public CreateObject(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Parse/Objects/CreateObject"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateObjectResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateObjectResultSet(result);
	}
