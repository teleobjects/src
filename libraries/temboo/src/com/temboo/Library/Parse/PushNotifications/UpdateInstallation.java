...
*/
public class UpdateInstallation extends Choreography {

	/**
	Create a new instance of the UpdateInstallation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateInstallation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Parse/PushNotifications/UpdateInstallation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateInstallationResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateInstallationResultSet(result);
	}
