...
*/
public class DeleteRole extends Choreography {

	/**
	Create a new instance of the DeleteRole Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRole(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Parse/Roles/DeleteRole"));
	}

	/** 
	Set the value of the ObjectID input for this Choreo. 

	@param String - (required, string) The ID of the role to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteRoleResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRoleResultSet(result);
	}
