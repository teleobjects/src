...
*/
public class RetrieveRole extends Choreography {

	/**
	Create a new instance of the RetrieveRole Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveRole(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Parse/Roles/RetrieveRole"));
	}

	/** 
	Set the value of the ObjectID input for this Choreo. 

	@param String - (required, string) The ID of the role to be retrieved.
	*/
	...
	*/
	 ...
	 */
	@Override
	public RetrieveRoleResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveRoleResultSet(result);
	}
