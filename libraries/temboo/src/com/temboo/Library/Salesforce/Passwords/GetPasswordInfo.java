...
*/
public class GetPasswordInfo extends Choreography {

	/**
	Create a new instance of the GetPasswordInfo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPasswordInfo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Passwords/GetPasswordInfo"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPasswordInfoResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPasswordInfoResultSet(result);
	}
