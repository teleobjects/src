...
*/
public class DeleteRecordFields extends Choreography {

	/**
	Create a new instance of the DeleteRecordFields Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRecordFields(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Objects/DeleteRecordFields"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRecordFieldsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRecordFieldsResultSet(result);
	}
