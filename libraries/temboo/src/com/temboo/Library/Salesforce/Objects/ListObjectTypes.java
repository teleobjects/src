...
*/
public class ListObjectTypes extends Choreography {

	/**
	Create a new instance of the ListObjectTypes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListObjectTypes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Objects/ListObjectTypes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListObjectTypesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListObjectTypesResultSet(result);
	}
