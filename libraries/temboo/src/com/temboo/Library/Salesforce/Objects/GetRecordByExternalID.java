...
*/
public class GetRecordByExternalID extends Choreography {

	/**
	Create a new instance of the GetRecordByExternalID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRecordByExternalID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Objects/GetRecordByExternalID"));
	}
	...
	*/
	public void setFieldName(String value) {
		this.inputs.setInput("FieldName", value);
	}
	...
	*/
	public void setFieldValue(String value) {
		this.inputs.setInput("FieldValue", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRecordByExternalIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecordByExternalIDResultSet(result);
	}
