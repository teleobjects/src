...
*/
public class DeleteRecord extends Choreography {

	/**
	Create a new instance of the DeleteRecord Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRecord(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Objects/DeleteRecord"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRecordResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRecordResultSet(result);
	}
