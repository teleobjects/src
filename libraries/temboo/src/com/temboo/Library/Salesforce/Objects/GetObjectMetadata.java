...
*/
public class GetObjectMetadata extends Choreography {

	/**
	Create a new instance of the GetObjectMetadata Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetObjectMetadata(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Salesforce/Objects/GetObjectMetadata"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetObjectMetadataResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetObjectMetadataResultSet(result);
	}
