...
public class ListLogEntries extends Choreography {
	...
	*/
	public ListLogEntries(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PagerDuty/LogEntries/ListLogEntries"));
	}
	...
	*/
	...
	@param Integer - (optional, integer) The number of log entries returned. Default (and max limit) is 100.
	*/
	...
	@param String - (optional, integer) The number of log entries returned. Default (and max limit) is 100.
	*/
	...
	@param Integer - (optional, integer) The offset of the first log entry record returned. Default is 0.
	*/
	...
	@param String - (optional, integer) The offset of the first log entry record returned. Default is 0.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListLogEntriesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListLogEntriesResultSet(result);
	}
