...
*/
public class ResolveIncident extends Choreography {

	/**
	Create a new instance of the ResolveIncident Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ResolveIncident(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PagerDuty/Incidents/ResolveIncident"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the incident to resolve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ResolveIncidentResultSet run() {
		JSONObject result = super.runWithResults();
		return new ResolveIncidentResultSet(result);
	}
