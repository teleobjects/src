...
public class InitializeOAuth extends Choreography {
	...
	*/
	public InitializeOAuth(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Uber/OAuth/InitializeOAuth"));
	}
	...
	*/
	...
	@param String - (optional, string) A space-delimited list of scopes to requests access for. See Choreo notes for a list of valid scopes.
	*/
