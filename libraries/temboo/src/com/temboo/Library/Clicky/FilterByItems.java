...
*/
public class FilterByItems extends Choreography {

	/**
	Create a new instance of the FilterByItems Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FilterByItems(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Clicky/FilterByItems"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FilterByItemsResultSet run() {
		JSONObject result = super.runWithResults();
		return new FilterByItemsResultSet(result);
	}
