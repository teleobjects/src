...
*/
public class SegmentationForVisitorsTodayViaSearch extends Choreography {
	...
	*/
	public SegmentationForVisitorsTodayViaSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Clicky/SegmentationForVisitorsTodayViaSearch"));
	}
	...
	*/
	...
	@param String - (optional, integer) The number of records you want to retrieve. Defaults to 30.
	*/
	...
	*/
	 ...
	 */
	@Override
	public SegmentationForVisitorsTodayViaSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new SegmentationForVisitorsTodayViaSearchResultSet(result);
	}
