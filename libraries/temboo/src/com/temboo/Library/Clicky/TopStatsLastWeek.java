...
*/
public class TopStatsLastWeek extends Choreography {

	/**
	Create a new instance of the TopStatsLastWeek Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TopStatsLastWeek(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Clicky/TopStatsLastWeek"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TopStatsLastWeekResultSet run() {
		JSONObject result = super.runWithResults();
		return new TopStatsLastWeekResultSet(result);
	}
