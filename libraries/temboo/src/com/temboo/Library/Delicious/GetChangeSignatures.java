...
*/
public class GetChangeSignatures extends Choreography {

	/**
	Create a new instance of the GetChangeSignatures Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetChangeSignatures(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Delicious/GetChangeSignatures"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetChangeSignaturesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetChangeSignaturesResultSet(result);
	}
