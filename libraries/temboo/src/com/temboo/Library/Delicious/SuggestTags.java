...
*/
public class SuggestTags extends Choreography {

	/**
	Create a new instance of the SuggestTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SuggestTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Delicious/SuggestTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SuggestTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new SuggestTagsResultSet(result);
	}
