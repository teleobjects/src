...
*/
public class DeleteBookmark extends Choreography {

	/**
	Create a new instance of the DeleteBookmark Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBookmark(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Delicious/DeleteBookmark"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBookmarkResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBookmarkResultSet(result);
	}
