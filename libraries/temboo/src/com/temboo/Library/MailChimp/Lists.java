...
public class Lists extends Choreography {
	...
	*/
	public Lists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/MailChimp/Lists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListsResultSet(result);
	}
