...
public class ListUserVolumes extends Choreography {
	...
	*/
	public ListUserVolumes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/FilesAnywhere/ListUserVolumes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListUserVolumesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListUserVolumesResultSet(result);
	}
