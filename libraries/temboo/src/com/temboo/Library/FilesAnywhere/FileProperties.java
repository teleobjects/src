...
*/
public class FileProperties extends Choreography {

	/**
	Create a new instance of the FileProperties Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FileProperties(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/FilesAnywhere/FileProperties"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FilePropertiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new FilePropertiesResultSet(result);
	}
