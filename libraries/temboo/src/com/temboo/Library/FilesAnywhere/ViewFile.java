...
*/
public class ViewFile extends Choreography {

	/**
	Create a new instance of the ViewFile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ViewFile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/FilesAnywhere/ViewFile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ViewFileResultSet run() {
		JSONObject result = super.runWithResults();
		return new ViewFileResultSet(result);
	}
