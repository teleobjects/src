...
*/
public class ItemCommentsList extends Choreography {

	/**
	Create a new instance of the ItemCommentsList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ItemCommentsList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/FilesAnywhere/ItemCommentsList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ItemCommentsListResultSet run() {
		JSONObject result = super.runWithResults();
		return new ItemCommentsListResultSet(result);
	}
