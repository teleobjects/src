...
public class UploadFile extends Choreography {
	...
	*/
	public UploadFile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/FilesAnywhere/UploadFile"));
	}
	...
	*/
	...
	@param String - (conditional, string) The base64 encoded file contents of the file you want to upload.
	*/
