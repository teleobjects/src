...
Restore a thread.
*/
public class RestoreThread extends Choreography {

	/**
	Create a new instance of the RestoreThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RestoreThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Threads/RestoreThread"));
	}
	...
	*/
	...
	@param String - (optional, string) Forum Short Name (i.e., the subdomain of the Disqus Site URL) of a thread that is to be restored.  Required if setting either ThreadByIdentification, or ThreadByLink.
	*/
	...
	*/
	...
	@param String - (conditional, integer) The ID of a thread that is to be restored. Required unless specifying ThreadIdentifier or ThreadLink. If using this parameter, ThreadIdentifier cannot be set.
	*/
	...
	@param String - (conditional, string) The identifier for the thread that is to be restored.  Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadLink cannot be used.
	*/
	...
	@param String - (conditional, string) A link pointing to the thread that is to be restored. Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadIdentifier cannot be set.
	*/
	...
	*/
	 ...
	 */
	@Override
	public RestoreThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new RestoreThreadResultSet(result);
	}
