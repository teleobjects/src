...
Remove a thread.
*/
public class RemoveThread extends Choreography {

	/**
	Create a new instance of the RemoveThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RemoveThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Threads/RemoveThread"));
	}
	...
	*/
	...
	@param String - (optional, string) The Forum Short Name (i.e., the subdomain of the Disqus Site URL) of a thread that is to be removed.  Required if setting either ThreadByIdentification, or ThreadByLink.
	*/
	...
	*/
	...
	@param String - (conditional, integer) The ID of a thread that is to be removed. Required unless specifying ThreadIdentifier or ThreadLink. If using this parameter, ThreadIdentifier cannot be set.
	*/
	...
	@param String - (conditional, string) The identifier for the thread that is to be removed.  Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadLink cannot be used.
	*/
	...
	@param String - (conditional, string) A link pointing to the thread that is to be removed. Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadIdentifier cannot be set.
	*/
	...
	*/
	 ...
	 */
	@Override
	public RemoveThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new RemoveThreadResultSet(result);
	}
