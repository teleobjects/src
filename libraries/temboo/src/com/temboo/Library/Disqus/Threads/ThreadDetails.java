...
*/
public class ThreadDetails extends Choreography {

	/**
	Create a new instance of the ThreadDetails Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ThreadDetails(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Threads/ThreadDetails"));
	}
	...
	*/
	...
	@param String - (optional, string) Indicates the relations to include with your response.  Valid entries include: author, category, or forum.
	*/
	...
	*/
	...
	@param String - (conditional, integer) The ID of a thread that is to be retrieved. Required unless specifying ThreadIdentifier or ThreadLink. If using this parameter, ThreadIdentifier cannot be set.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ThreadDetailsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ThreadDetailsResultSet(result);
	}
