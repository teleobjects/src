...
Approves a post.
*/
public class ApprovePosts extends Choreography {

	/**
	Create a new instance of the ApprovePosts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ApprovePosts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Posts/ApprovePosts"));
	}
	...
	*/
	...
	@param String - (required, integer) The post ID which is to be approved. Note that you must be a forum moderator to approve posts.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ApprovePostsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ApprovePostsResultSet(result);
	}
