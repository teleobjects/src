...
*/
public class ListModerators extends Choreography {

	/**
	Create a new instance of the ListModerators Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListModerators(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Forums/ListModerators"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListModeratorsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListModeratorsResultSet(result);
	}
