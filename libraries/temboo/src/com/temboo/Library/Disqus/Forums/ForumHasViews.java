...
*/
public class ForumHasViews extends Choreography {

	/**
	Create a new instance of the ForumHasViews Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ForumHasViews(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Forums/ForumHasViews"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ForumHasViewsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ForumHasViewsResultSet(result);
	}
