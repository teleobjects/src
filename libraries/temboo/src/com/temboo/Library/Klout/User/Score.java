...
public class Score extends Choreography {
	...
	*/
	public Score(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Klout/User/Score"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ScoreResultSet run() {
		JSONObject result = super.runWithResults();
		return new ScoreResultSet(result);
	}
