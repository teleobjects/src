...
public class ByTwitterID extends Choreography {
	...
	*/
	public ByTwitterID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Klout/Identity/ByTwitterID"));
	}
	...
	*/
	public void setTwitterID(Integer value) {
		this.inputs.setInput("TwitterID", value);
	}

	/** 
	Set the value of the TwitterID input for this Choreo as a String. 

	@param String - (required, integer) The numeric ID for a Twitter user.
	*/
	 ...
	 */
	@Override
	public ByTwitterIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ByTwitterIDResultSet(result);
	}
