...
public class ByKloutID extends Choreography {
	...
	*/
	public ByKloutID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Klout/Identity/ByKloutID"));
	}
	...
	*/
	public void setKloutID(Integer value) {
		this.inputs.setInput("KloutID", value);
	}

	/** 
	Set the value of the KloutID input for this Choreo as a String. 

	@param String - (required, integer) The numeric ID for a Klout user.
	*/
	 ...
	 */
	@Override
	public ByKloutIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ByKloutIDResultSet(result);
	}
