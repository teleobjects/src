...
public class ByTwitterScreenName extends Choreography {
	...
	*/
	public ByTwitterScreenName(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Klout/Identity/ByTwitterScreenName"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ByTwitterScreenNameResultSet run() {
		JSONObject result = super.runWithResults();
		return new ByTwitterScreenNameResultSet(result);
	}
