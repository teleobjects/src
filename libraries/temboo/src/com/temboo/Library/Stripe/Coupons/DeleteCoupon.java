...
public class DeleteCoupon extends Choreography {
	...
	*/
	public DeleteCoupon(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Stripe/Coupons/DeleteCoupon"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteCouponResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteCouponResultSet(result);
	}
