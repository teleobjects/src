...
*/
public class PayInvoice extends Choreography {

	/**
	Create a new instance of the PayInvoice Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PayInvoice(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Stripe/Invoices/PayInvoice"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PayInvoiceResultSet run() {
		JSONObject result = super.runWithResults();
		return new PayInvoiceResultSet(result);
	}
