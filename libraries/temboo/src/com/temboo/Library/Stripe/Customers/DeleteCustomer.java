...
*/
public class DeleteCustomer extends Choreography {

	/**
	Create a new instance of the DeleteCustomer Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteCustomer(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Stripe/Customers/DeleteCustomer"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteCustomerResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteCustomerResultSet(result);
	}
