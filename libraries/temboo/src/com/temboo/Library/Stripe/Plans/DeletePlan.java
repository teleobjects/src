...
public class DeletePlan extends Choreography {
	...
	*/
	public DeletePlan(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Stripe/Plans/DeletePlan"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeletePlanResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeletePlanResultSet(result);
	}
