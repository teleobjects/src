...
*/
public class TopProperties extends Choreography {

	/**
	Create a new instance of the TopProperties Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TopProperties(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Mixpanel/DataExport/Properties/TopProperties"));
	}
	...
	*/
	...
	@param Integer - (optional, integer) The maximum number of properties to return. Defaults to 10.
	*/
	...
	@param String - (optional, integer) The maximum number of properties to return. Defaults to 10.
	*/
	 ...
	 */
	@Override
	public TopPropertiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new TopPropertiesResultSet(result);
	}
