...
*/
public class Add extends Choreography {

	/**
	Create a new instance of the Add Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Add(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Mixpanel/Profiles/Add"));
	}
	...
	*/
	...
	@param String - (conditional, json) A JSON object containing names and values of custom profile properties. The current value will be added to any existing property value. If the property doesn't exist, the value will be added to 0.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddResultSet(result);
	}
