...
*/
public class Unset extends Choreography {

	/**
	Create a new instance of the Unset Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Unset(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Mixpanel/Profiles/Unset"));
	}
	...
	*/
	...
	@param String - (conditional, json) A JSON array of property names to remove from a profile.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnsetResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnsetResultSet(result);
	}
