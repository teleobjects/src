...
*/
public class Union extends Choreography {

	/**
	Create a new instance of the Union Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Union(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Mixpanel/Profiles/Union"));
	}
	...
	*/
	...
	@param String - (required, json) A JSON object containing a list name and an array of values. The list values in the request are merged with the existing list on the user profile, ignoring duplicate list values.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnionResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnionResultSet(result);
	}
