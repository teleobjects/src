...
public class SetOnce extends Choreography {
	...
	*/
	public SetOnce(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Mixpanel/Profiles/SetOnce"));
	}
	...
	*/
	...
	@param String - (conditional, json) A JSON object containing names and values of custom profile properties. Note that properties existing already will not be overwritten.
	*/
	...
	*/
	 ...
	 */
	@Override
	public SetOnceResultSet run() {
		JSONObject result = super.runWithResults();
		return new SetOnceResultSet(result);
	}
