...
*/
public class GetSerialPortOutput extends Choreography {

	/**
	Create a new instance of the GetSerialPortOutput Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSerialPortOutput(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Instances/GetSerialPortOutput"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSerialPortOutputResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSerialPortOutputResultSet(result);
	}
