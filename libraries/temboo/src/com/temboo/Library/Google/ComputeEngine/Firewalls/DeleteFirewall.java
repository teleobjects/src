...
*/
public class DeleteFirewall extends Choreography {

	/**
	Create a new instance of the DeleteFirewall Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteFirewall(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Firewalls/DeleteFirewall"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteFirewallResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteFirewallResultSet(result);
	}
