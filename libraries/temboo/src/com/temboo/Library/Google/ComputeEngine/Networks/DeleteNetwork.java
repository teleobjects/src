...
*/
public class DeleteNetwork extends Choreography {

	/**
	Create a new instance of the DeleteNetwork Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteNetwork(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Networks/DeleteNetwork"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteNetworkResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteNetworkResultSet(result);
	}
