...
*/
public class ListImages extends Choreography {

	/**
	Create a new instance of the ListImages Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListImages(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Images/ListImages"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListImagesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListImagesResultSet(result);
	}
