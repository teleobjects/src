...
*/
public class AggregatedList extends Choreography {

	/**
	Create a new instance of the AggregatedList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AggregatedList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/GlobalOperations/AggregatedList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AggregatedListResultSet run() {
		JSONObject result = super.runWithResults();
		return new AggregatedListResultSet(result);
	}
