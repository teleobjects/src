...
*/
public class DeleteRoute extends Choreography {

	/**
	Create a new instance of the DeleteRoute Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRoute(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Routes/DeleteRoute"));
	}
	...
	*/
	public void setRoute(String value) {
		this.inputs.setInput("Route", value);
	}
	 ...
	 */
	@Override
	public DeleteRouteResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRouteResultSet(result);
	}
