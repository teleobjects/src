...
*/
public class DeleteZoneOperation extends Choreography {

	/**
	Create a new instance of the DeleteZoneOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteZoneOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/ZoneOperations/DeleteZoneOperation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteZoneOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteZoneOperationResultSet(result);
	}
