...
*/
public class DeleteImage extends Choreography {

	/**
	Create a new instance of the DeleteImage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteImage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Images/DeleteImage"));
	}
	...
	*/
	public void setImage(String value) {
		this.inputs.setInput("Image", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteImageResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteImageResultSet(result);
	}
