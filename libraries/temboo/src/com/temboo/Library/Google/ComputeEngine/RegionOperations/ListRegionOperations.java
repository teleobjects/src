...
*/
public class ListRegionOperations extends Choreography {

	/**
	Create a new instance of the ListRegionOperations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRegionOperations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/RegionOperations/ListRegionOperations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRegionOperationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRegionOperationsResultSet(result);
	}
