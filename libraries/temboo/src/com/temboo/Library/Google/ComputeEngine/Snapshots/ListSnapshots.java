...
*/
public class ListSnapshots extends Choreography {

	/**
	Create a new instance of the ListSnapshots Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSnapshots(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Snapshots/ListSnapshots"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSnapshotsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSnapshotsResultSet(result);
	}
