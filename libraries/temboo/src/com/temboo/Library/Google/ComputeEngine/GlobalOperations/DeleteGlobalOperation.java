...
*/
public class DeleteGlobalOperation extends Choreography {

	/**
	Create a new instance of the DeleteGlobalOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteGlobalOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/GlobalOperations/DeleteGlobalOperation"));
	}
	...
	*/
	public void setOperation(String value) {
		this.inputs.setInput("Operation", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteGlobalOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteGlobalOperationResultSet(result);
	}
