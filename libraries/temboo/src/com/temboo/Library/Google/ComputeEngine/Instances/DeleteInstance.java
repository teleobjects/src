...
*/
public class DeleteInstance extends Choreography {

	/**
	Create a new instance of the DeleteInstance Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteInstance(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Instances/DeleteInstance"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteInstanceResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteInstanceResultSet(result);
	}
