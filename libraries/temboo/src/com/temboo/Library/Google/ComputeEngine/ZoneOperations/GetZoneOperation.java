...
*/
public class GetZoneOperation extends Choreography {

	/**
	Create a new instance of the GetZoneOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetZoneOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/ZoneOperations/GetZoneOperation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetZoneOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetZoneOperationResultSet(result);
	}
