...
*/
public class GetGlobalOperation extends Choreography {

	/**
	Create a new instance of the GetGlobalOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetGlobalOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/GlobalOperations/GetGlobalOperation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetGlobalOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetGlobalOperationResultSet(result);
	}
