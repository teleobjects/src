...
public class GetRegion extends Choreography {
	...
	*/
	public GetRegion(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Regions/GetRegion"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRegionResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRegionResultSet(result);
	}
