...
*/
public class ListAddresses extends Choreography {

	/**
	Create a new instance of the ListAddresses Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAddresses(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Addresses/ListAddresses"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAddressesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAddressesResultSet(result);
	}
