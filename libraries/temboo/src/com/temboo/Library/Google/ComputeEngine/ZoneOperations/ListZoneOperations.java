...
*/
public class ListZoneOperations extends Choreography {

	/**
	Create a new instance of the ListZoneOperations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListZoneOperations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/ZoneOperations/ListZoneOperations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListZoneOperationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListZoneOperationsResultSet(result);
	}
