...
*/
public class ListGlobalOperations extends Choreography {

	/**
	Create a new instance of the ListGlobalOperations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGlobalOperations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/GlobalOperations/ListGlobalOperations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGlobalOperationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGlobalOperationsResultSet(result);
	}
