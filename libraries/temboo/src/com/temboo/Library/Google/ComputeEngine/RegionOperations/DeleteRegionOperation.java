...
*/
public class DeleteRegionOperation extends Choreography {

	/**
	Create a new instance of the DeleteRegionOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRegionOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/RegionOperations/DeleteRegionOperation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRegionOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRegionOperationResultSet(result);
	}
