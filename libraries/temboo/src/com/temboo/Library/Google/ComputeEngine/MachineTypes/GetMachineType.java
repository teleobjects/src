...
*/
public class GetMachineType extends Choreography {

	/**
	Create a new instance of the GetMachineType Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMachineType(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/MachineTypes/GetMachineType"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMachineTypeResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMachineTypeResultSet(result);
	}
