...
*/
public class UpdateFirewall extends Choreography {

	/**
	Create a new instance of the UpdateFirewall Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateFirewall(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Firewalls/UpdateFirewall"));
	}
	...
	*/
	public void setFirewall(String value) {
		this.inputs.setInput("Firewall", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateFirewallResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateFirewallResultSet(result);
	}
