...
public class SetCommonInstanceMetadata extends Choreography {
	...
	*/
	public SetCommonInstanceMetadata(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Projects/SetCommonInstanceMetadata"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SetCommonInstanceMetadataResultSet run() {
		JSONObject result = super.runWithResults();
		return new SetCommonInstanceMetadataResultSet(result);
	}
