...
*/
public class ListMachineTypes extends Choreography {

	/**
	Create a new instance of the ListMachineTypes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMachineTypes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/MachineTypes/ListMachineTypes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMachineTypesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMachineTypesResultSet(result);
	}
