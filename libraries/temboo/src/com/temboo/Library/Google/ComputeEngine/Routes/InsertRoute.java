...
*/
public class InsertRoute extends Choreography {

	/**
	Create a new instance of the InsertRoute Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public InsertRoute(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Routes/InsertRoute"));
	}
	...
	*/
	public void setRouteResource(String value) {
		this.inputs.setInput("RouteResource", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public InsertRouteResultSet run() {
		JSONObject result = super.runWithResults();
		return new InsertRouteResultSet(result);
	}
