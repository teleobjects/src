...
*/
public class GetZone extends Choreography {

	/**
	Create a new instance of the GetZone Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetZone(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Zones/GetZone"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetZoneResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetZoneResultSet(result);
	}
