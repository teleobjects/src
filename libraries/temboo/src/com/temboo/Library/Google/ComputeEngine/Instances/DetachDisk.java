...
*/
public class DetachDisk extends Choreography {

	/**
	Create a new instance of the DetachDisk Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DetachDisk(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Instances/DetachDisk"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DetachDiskResultSet run() {
		JSONObject result = super.runWithResults();
		return new DetachDiskResultSet(result);
	}
