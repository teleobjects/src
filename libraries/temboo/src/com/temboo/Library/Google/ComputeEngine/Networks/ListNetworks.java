...
*/
public class ListNetworks extends Choreography {

	/**
	Create a new instance of the ListNetworks Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListNetworks(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Networks/ListNetworks"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListNetworksResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListNetworksResultSet(result);
	}
