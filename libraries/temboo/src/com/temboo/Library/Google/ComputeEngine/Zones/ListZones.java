...
*/
public class ListZones extends Choreography {

	/**
	Create a new instance of the ListZones Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListZones(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Zones/ListZones"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListZonesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListZonesResultSet(result);
	}
