...
*/
public class DeleteAddress extends Choreography {

	/**
	Create a new instance of the DeleteAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Addresses/DeleteAddress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteAddressResultSet(result);
	}
