...
*/
public class GetRegionOperation extends Choreography {

	/**
	Create a new instance of the GetRegionOperation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRegionOperation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/RegionOperations/GetRegionOperation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRegionOperationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRegionOperationResultSet(result);
	}
