...
*/
public class GetFirewall extends Choreography {

	/**
	Create a new instance of the GetFirewall Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFirewall(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Firewalls/GetFirewall"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFirewallResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFirewallResultSet(result);
	}
