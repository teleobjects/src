...
*/
public class ListRegions extends Choreography {

	/**
	Create a new instance of the ListRegions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRegions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Regions/ListRegions"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRegionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRegionsResultSet(result);
	}
