...
*/
public class ListFirewalls extends Choreography {

	/**
	Create a new instance of the ListFirewalls Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListFirewalls(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Firewalls/ListFirewalls"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListFirewallsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListFirewallsResultSet(result);
	}
