...
*/
public class GetRoute extends Choreography {

	/**
	Create a new instance of the GetRoute Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRoute(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Routes/GetRoute"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRouteResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRouteResultSet(result);
	}
