...
*/
public class GetImage extends Choreography {

	/**
	Create a new instance of the GetImage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetImage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Images/GetImage"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetImageResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetImageResultSet(result);
	}
