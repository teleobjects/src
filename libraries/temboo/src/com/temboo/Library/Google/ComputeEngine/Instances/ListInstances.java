...
*/
public class ListInstances extends Choreography {

	/**
	Create a new instance of the ListInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Instances/ListInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListInstancesResultSet(result);
	}
