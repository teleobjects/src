...
*/
public class GetAddress extends Choreography {

	/**
	Create a new instance of the GetAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Addresses/GetAddress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAddressResultSet(result);
	}
