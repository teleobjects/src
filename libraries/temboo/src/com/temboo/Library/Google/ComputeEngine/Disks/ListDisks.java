...
*/
public class ListDisks extends Choreography {

	/**
	Create a new instance of the ListDisks Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListDisks(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Disks/ListDisks"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListDisksResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListDisksResultSet(result);
	}
