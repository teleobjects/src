...
*/
public class DeleteDisk extends Choreography {

	/**
	Create a new instance of the DeleteDisk Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteDisk(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Disks/DeleteDisk"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteDiskResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteDiskResultSet(result);
	}
