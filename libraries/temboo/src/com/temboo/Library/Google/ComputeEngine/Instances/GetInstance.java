...
*/
public class GetInstance extends Choreography {

	/**
	Create a new instance of the GetInstance Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetInstance(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/ComputeEngine/Instances/GetInstance"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetInstanceResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetInstanceResultSet(result);
	}
