...
*/
public class ListByCircle extends Choreography {

	/**
	Create a new instance of the ListByCircle Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListByCircle(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Plus/Domains/People/ListByCircle"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListByCircleResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListByCircleResultSet(result);
	}
