...
*/
public class ListByActivity extends Choreography {

	/**
	Create a new instance of the ListByActivity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListByActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Plus/Domains/People/ListByActivity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListByActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListByActivityResultSet(result);
	}
