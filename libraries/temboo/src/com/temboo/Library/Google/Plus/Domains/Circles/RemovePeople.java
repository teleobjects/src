...
*/
public class RemovePeople extends Choreography {

	/**
	Create a new instance of the RemovePeople Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RemovePeople(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Plus/Domains/Circles/RemovePeople"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RemovePeopleResultSet run() {
		JSONObject result = super.runWithResults();
		return new RemovePeopleResultSet(result);
	}
