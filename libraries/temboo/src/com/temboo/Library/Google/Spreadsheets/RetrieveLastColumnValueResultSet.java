...
*/
public  class RetrieveLastColumnValueResultSet extends ResultSet {
		
	public RetrieveLastColumnValueResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getColumn() {
		return this.getResultString("Column");
	}
	/** 
	...
	*/
	public String getRow() {
		return this.getResultString("Row");
	}
}