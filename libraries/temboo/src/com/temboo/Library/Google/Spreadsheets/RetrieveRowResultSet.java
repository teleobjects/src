...
*/
public  class RetrieveRowResultSet extends ResultSet {
		
	public RetrieveRowResultSet(JSONObject doc) {
		super(doc);
	}
	...
	@return String - (string) The row data in CSV format.
	*/
	public String getRowData() {
		return this.getResultString("RowData");
	}
	/** 
