...
*/
public class UploadSpreadsheet extends Choreography {

	/**
	Create a new instance of the UploadSpreadsheet Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UploadSpreadsheet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/UploadSpreadsheet"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UploadSpreadsheetResultSet run() {
		JSONObject result = super.runWithResults();
		return new UploadSpreadsheetResultSet(result);
	}
