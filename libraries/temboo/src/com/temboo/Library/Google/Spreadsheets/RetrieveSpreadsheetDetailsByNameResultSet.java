...
*/
public  class RetrieveSpreadsheetDetailsByNameResultSet extends ResultSet {
		
	public RetrieveSpreadsheetDetailsByNameResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getSpreadsheetDetails() {
		return this.getResultString("SpreadsheetDetails");
	}
	/** 
