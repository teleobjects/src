...
*/
public class SendDraft extends Choreography {

	/**
	Create a new instance of the SendDraft Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SendDraft(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Drafts/SendDraft"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the draft to send.
	*/
	...
	*/
	 ...
	 */
	@Override
	public SendDraftResultSet run() {
		JSONObject result = super.runWithResults();
		return new SendDraftResultSet(result);
	}
