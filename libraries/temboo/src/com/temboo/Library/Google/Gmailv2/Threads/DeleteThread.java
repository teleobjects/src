...
*/
public class DeleteThread extends Choreography {

	/**
	Create a new instance of the DeleteThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/DeleteThread"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the thread to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteThreadResultSet(result);
	}
