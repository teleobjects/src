...
public class ListThreads extends Choreography {
	...
	*/
	public ListThreads(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/ListThreads"));
	}
	...
	*/
	...
	@param Boolean - (optional, boolean) Set to "true" to include threads from SPAM and TRASH in the results. Defaults to "false".
	*/
	...
	@param String - (optional, boolean) Set to "true" to include threads from SPAM and TRASH in the results. Defaults to "false".
	*/
	...
	@param String - (optional, json) A JSON array containing labels to filter by. When specified, only threads with labels that match are returned.
	*/
	...
	*/
	...
	@param String - (optional, string) Filters threads that match the specified query. Supports the same query format as the Gmail search box. For example, "from:someuser@example.com rfc822msgid: is:unread".
	*/
