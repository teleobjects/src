...
*/
public class GetThread extends Choreography {

	/**
	Create a new instance of the GetThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/GetThread"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the thread to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetThreadResultSet(result);
	}
