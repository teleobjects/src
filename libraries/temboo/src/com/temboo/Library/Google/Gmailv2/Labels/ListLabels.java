...
*/
public class ListLabels extends Choreography {

	/**
	Create a new instance of the ListLabels Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListLabels(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Labels/ListLabels"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListLabelsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListLabelsResultSet(result);
	}
