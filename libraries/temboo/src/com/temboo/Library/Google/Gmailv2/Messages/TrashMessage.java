...
*/
public class TrashMessage extends Choreography {

	/**
	Create a new instance of the TrashMessage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TrashMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Messages/TrashMessage"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the message to move to the trash.
	*/
	...
	*/
	 ...
	 */
	@Override
	public TrashMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new TrashMessageResultSet(result);
	}
