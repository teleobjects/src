...
*/
public class GetNextMessage extends Choreography {

	/**
	Create a new instance of the GetNextMessage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetNextMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Messages/GetNextMessage"));
	}
	...
	*/
	...
	@param String - (conditional, string) Returns messages with a label matching this ID (e.g., INBOX, UNREAD, Label_1, etc.)
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetNextMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetNextMessageResultSet(result);
	}
