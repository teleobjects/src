...
*/
public class GetLabel extends Choreography {

	/**
	Create a new instance of the GetLabel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLabel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Labels/GetLabel"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the label to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetLabelResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLabelResultSet(result);
	}
