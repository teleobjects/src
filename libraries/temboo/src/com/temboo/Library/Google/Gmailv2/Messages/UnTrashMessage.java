...
*/
public class UnTrashMessage extends Choreography {

	/**
	Create a new instance of the UnTrashMessage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UnTrashMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Messages/UnTrashMessage"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the message to restore.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnTrashMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnTrashMessageResultSet(result);
	}
