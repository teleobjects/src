...
*/
public class TrashThread extends Choreography {

	/**
	Create a new instance of the TrashThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TrashThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/TrashThread"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the thread to move to the trash.
	*/
	...
	*/
	 ...
	 */
	@Override
	public TrashThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new TrashThreadResultSet(result);
	}
