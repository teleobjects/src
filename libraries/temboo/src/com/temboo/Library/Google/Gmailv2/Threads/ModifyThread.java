...
*/
public class ModifyThread extends Choreography {

	/**
	Create a new instance of the ModifyThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ModifyThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/ModifyThread"));
	}
	...
	*/
	...
	@param String - (conditional, json) An array of label IDs to apply to the thread.
	*/
	...
	*/
	...
	@param String - (conditional, json) An array of label IDs to remove from the thread.
	*/
	...
	@param String - (required, string) The ID of the thread to modify.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ModifyThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new ModifyThreadResultSet(result);
	}
