...
*/
public class UnTrashThread extends Choreography {

	/**
	Create a new instance of the UnTrashThread Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UnTrashThread(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Threads/UnTrashThread"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the thread to restore.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnTrashThreadResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnTrashThreadResultSet(result);
	}
