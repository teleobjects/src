...
Creates a new label.
*/
public class CreateLabel extends Choreography {

	/**
	Create a new instance of the CreateLabel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateLabel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Labels/CreateLabel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateLabelResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateLabelResultSet(result);
	}
