...
*/
public class DeleteLabel extends Choreography {

	/**
	Create a new instance of the DeleteLabel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteLabel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Labels/DeleteLabel"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the label to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteLabelResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteLabelResultSet(result);
	}
