...
*/
public class GetSetting extends Choreography {

	/**
	Create a new instance of the GetSetting Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSetting(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Calendar/GetSetting"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSettingResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSettingResultSet(result);
	}
