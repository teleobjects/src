...
*/
public class DeleteCalendar extends Choreography {

	/**
	Create a new instance of the DeleteCalendar Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteCalendar(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Calendar/DeleteCalendar"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteCalendarResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteCalendarResultSet(result);
	}
