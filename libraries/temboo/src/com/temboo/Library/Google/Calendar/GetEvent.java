...
*/
public class GetEvent extends Choreography {

	/**
	Create a new instance of the GetEvent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEvent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Calendar/GetEvent"));
	}
	...
	*/
	...
	@param String - (required, string) The unique ID for the calendar with the event to retrieve. Note that calendar IDs can be retrieved by running GetAllCalendars or SearchCalendarsByName.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetEventResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEventResultSet(result);
	}
