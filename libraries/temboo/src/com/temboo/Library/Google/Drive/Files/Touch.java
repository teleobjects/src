...
*/
public class Touch extends Choreography {

	/**
	Create a new instance of the Touch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Touch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Drive/Files/Touch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TouchResultSet run() {
		JSONObject result = super.runWithResults();
		return new TouchResultSet(result);
	}
