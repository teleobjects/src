...
public class Get extends Choreography {
	...
	*/
	public Get(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Drive/Files/Get"));
	}
	...
	*/
	public void setExportFormat(String value) {
		this.inputs.setInput("ExportFormat", value);
	}
	...
	*/
	public void setUpdateViewDate(Boolean value) {
		this.inputs.setInput("UpdateViewDate", value);
	}

	/** 
	Set the value of the UpdateViewDate input for this Choreo as a String. 

	@param String - (optional, boolean) Whether to update the view date after successfully retrieving the file. Default value is false.
	*/
