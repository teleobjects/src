...
public class Insert extends Choreography {
	...
	*/
	public Insert(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Drive/Permissions/Insert"));
	}
	...
	*/
	public void setSendNotificationEmails(Boolean value) {
		this.inputs.setInput("SendNotificationEmails", value);
	}

	/** 
	Set the value of the SendNotificationEmails input for this Choreo as a String. 

	@param String - (optional, boolean) Whether to send notification emails. (Default: true).
	*/
