...
*/
public class Trash extends Choreography {

	/**
	Create a new instance of the Trash Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Trash(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Drive/Files/Trash"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TrashResultSet run() {
		JSONObject result = super.runWithResults();
		return new TrashResultSet(result);
	}
