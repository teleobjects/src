...
*/
public class GetDrivingDirections extends Choreography {

	/**
	Create a new instance of the GetDrivingDirections Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDrivingDirections(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Directions/GetDrivingDirections"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetDrivingDirectionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDrivingDirectionsResultSet(result);
	}
