...
*/
public class GetWalkingDirections extends Choreography {

	/**
	Create a new instance of the GetWalkingDirections Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWalkingDirections(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Directions/GetWalkingDirections"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWalkingDirectionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWalkingDirectionsResultSet(result);
	}
