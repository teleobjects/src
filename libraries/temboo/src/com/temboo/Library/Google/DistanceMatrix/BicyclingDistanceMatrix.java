...
public class BicyclingDistanceMatrix extends Choreography {
	...
	*/
	public BicyclingDistanceMatrix(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/DistanceMatrix/BicyclingDistanceMatrix"));
	}
	...
	*/
	 ...
	 */
	@Override
	public BicyclingDistanceMatrixResultSet run() {
		JSONObject result = super.runWithResults();
		return new BicyclingDistanceMatrixResultSet(result);
	}
