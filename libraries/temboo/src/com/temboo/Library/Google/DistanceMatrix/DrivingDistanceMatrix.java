...
*/
public class DrivingDistanceMatrix extends Choreography {

	/**
	Create a new instance of the DrivingDistanceMatrix Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DrivingDistanceMatrix(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/DistanceMatrix/DrivingDistanceMatrix"));
	}
	...
	*/
	public void setAvoid(String value) {
		this.inputs.setInput("Avoid", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DrivingDistanceMatrixResultSet run() {
		JSONObject result = super.runWithResults();
		return new DrivingDistanceMatrixResultSet(result);
	}
