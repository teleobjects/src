...
*/
public class FootprintLookup extends Choreography {

	/**
	Create a new instance of the FootprintLookup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FootprintLookup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/FootprintLookup"));
	}
	...
	*/
	...
	/** 
	Set the value of the Identifier input for this Choreo as a String. 

	@param String - (required, integer) The place identifier that you want to use for the search. Note that this identifier is returned in the <geometryRef> response element of other Unlock Places search Choreos.
	*/
	...
	*/
	 ...
	 */
	@Override
	public FootprintLookupResultSet run() {
		JSONObject result = super.runWithResults();
		return new FootprintLookupResultSet(result);
	}
