...
*/
public class SpacialNameSearch extends Choreography {

	/**
	Create a new instance of the SpacialNameSearch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SpacialNameSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/SpacialNameSearch"));
	}
	...
	*/
	...
	@param String - (required, decimal) The maximum latitude point of a bounding box.
	*/
	...
	*/
	...
	@param String - (required, decimal) The maximum longitude point of a bounding box.
	*/
	...
	*/
	...
	@param String - (required, decimal) The minimum latitude point of a bounding box.
	*/
	...
	*/
	...
	@param String - (required, decimal) The minimum longitude point of a bounding box.
	*/
	...
	*/
	 ...
	 */
	@Override
	public SpacialNameSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new SpacialNameSearchResultSet(result);
	}
