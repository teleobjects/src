...
*/
public class UniqueNameSearch extends Choreography {

	/**
	Create a new instance of the UniqueNameSearch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UniqueNameSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/UniqueNameSearch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UniqueNameSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new UniqueNameSearchResultSet(result);
	}
