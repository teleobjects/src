...
*/
public class PostCodeSearch extends Choreography {

	/**
	Create a new instance of the PostCodeSearch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PostCodeSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/PostCodeSearch"));
	}
	...
	*/
	public void setPostCode(String value) {
		this.inputs.setInput("PostCode", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public PostCodeSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new PostCodeSearchResultSet(result);
	}
