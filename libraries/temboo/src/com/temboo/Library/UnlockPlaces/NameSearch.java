...
*/
public class NameSearch extends Choreography {

	/**
	Create a new instance of the NameSearch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public NameSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/NameSearch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public NameSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new NameSearchResultSet(result);
	}
