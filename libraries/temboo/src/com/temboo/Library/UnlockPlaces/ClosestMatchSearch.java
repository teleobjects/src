...
*/
public class ClosestMatchSearch extends Choreography {

	/**
	Create a new instance of the ClosestMatchSearch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ClosestMatchSearch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/UnlockPlaces/ClosestMatchSearch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ClosestMatchSearchResultSet run() {
		JSONObject result = super.runWithResults();
		return new ClosestMatchSearchResultSet(result);
	}
