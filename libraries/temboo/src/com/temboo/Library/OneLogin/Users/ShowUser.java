...
*/
public class ShowUser extends Choreography {

	/**
	Create a new instance of the ShowUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/OneLogin/Users/ShowUser"));
	}
	...
	*/
	...
	@param String - (required, integer) The id the user you want to return.
	*/
	 ...
	 */
	@Override
	public ShowUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowUserResultSet(result);
	}
