...
*/
public class ShowEvent extends Choreography {

	/**
	Create a new instance of the ShowEvent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowEvent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/OneLogin/Events/ShowEvent"));
	}
	...
	*/
	...
	@param String - (required, integer) The id the event you want to return.
	*/
	 ...
	 */
	@Override
	public ShowEventResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowEventResultSet(result);
	}
