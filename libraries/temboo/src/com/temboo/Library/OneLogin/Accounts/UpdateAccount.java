...
public class UpdateAccount extends Choreography {
	...
	*/
	public UpdateAccount(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/OneLogin/Accounts/UpdateAccount"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the account to update.
	*/
