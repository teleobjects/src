...
*/
public class ShowAccount extends Choreography {

	/**
	Create a new instance of the ShowAccount Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowAccount(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/OneLogin/Accounts/ShowAccount"));
	}
	...
	*/
	...
	@param String - (required, integer) The id the account you want to return.
	*/
	 ...
	 */
	@Override
	public ShowAccountResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowAccountResultSet(result);
	}
