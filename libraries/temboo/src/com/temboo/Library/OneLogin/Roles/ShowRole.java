package com.temboo.Library.OneLogin.Roles;
...
*/
public class ShowRole extends Choreography {

	/**
	Create a new instance of the ShowRole Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowRole(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/OneLogin/Roles/ShowRole"));
	}
	...
	*/
	...
	@param String - (required, integer) The id the role you want to return.
	*/
	 ...
	 */
	@Override
	public ShowRoleResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowRoleResultSet(result);
	}
