...
public class Post extends Choreography {
	...
	*/
	...
	/** 
	Set the value of the EncodedData input for this Choreo. 

	@param String - (optional, multiline) The Base64 encoded content of a file that should be specified as the request body. This input should be used instead of the RequestBody input when posting binary data.
	*/
	public void setEncodedData(String value) {
		this.inputs.setInput("EncodedData", value);
	}
	...
	@param String - (optional, multiline) The request body for the POST. This input is used when the request body is text e.g. application/json, application/xml, plain/text, etc. Use the EncodedData input when posting binary.
	*/
