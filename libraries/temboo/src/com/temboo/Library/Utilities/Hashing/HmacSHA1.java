...
public class HmacSHA1 extends Choreography {
	...
	*/
	public HmacSHA1(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Hashing/HmacSHA1"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HmacSHA1ResultSet run() {
		JSONObject result = super.runWithResults();
		return new HmacSHA1ResultSet(result);
	}
