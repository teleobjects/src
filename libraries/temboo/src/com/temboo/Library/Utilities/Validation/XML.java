...
*/
public class XML extends Choreography {

	/**
	Create a new instance of the XML Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public XML(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/XML"));
	}
	...
	*/
	public void setXMLFile(String value) {
		this.inputs.setInput("XMLFile", value);
	}
	...
	*/
	public void setXSDFile(String value) {
		this.inputs.setInput("XSDFile", value);
	}
