...
*/
public class DutchPostalCodes extends Choreography {

	/**
	Create a new instance of the DutchPostalCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DutchPostalCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/DutchPostalCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DutchPostalCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new DutchPostalCodesResultSet(result);
	}
