...
*/
public class JSON extends Choreography {

	/**
	Create a new instance of the JSON Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public JSON(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/JSON"));
	}
	...
	*/
	 ...
	 */
	@Override
	public JSONResultSet run() {
		JSONObject result = super.runWithResults();
		return new JSONResultSet(result);
	}
