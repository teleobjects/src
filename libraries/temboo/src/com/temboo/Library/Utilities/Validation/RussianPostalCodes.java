...
*/
public class RussianPostalCodes extends Choreography {

	/**
	Create a new instance of the RussianPostalCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RussianPostalCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/RussianPostalCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RussianPostalCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new RussianPostalCodesResultSet(result);
	}
