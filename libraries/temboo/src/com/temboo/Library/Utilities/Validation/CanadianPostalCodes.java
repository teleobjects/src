...
public class CanadianPostalCodes extends Choreography {
	...
	*/
	public CanadianPostalCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/CanadianPostalCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CanadianPostalCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new CanadianPostalCodesResultSet(result);
	}
