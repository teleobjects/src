...
*/
public class USPostalCodes extends Choreography {

	/**
	Create a new instance of the USPostalCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public USPostalCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/USPostalCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public USPostalCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new USPostalCodesResultSet(result);
	}
