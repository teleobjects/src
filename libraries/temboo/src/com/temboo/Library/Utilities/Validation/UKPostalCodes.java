...
*/
public class UKPostalCodes extends Choreography {

	/**
	Create a new instance of the UKPostalCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UKPostalCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Validation/UKPostalCodes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UKPostalCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new UKPostalCodesResultSet(result);
	}
