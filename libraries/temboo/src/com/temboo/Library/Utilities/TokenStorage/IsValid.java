...
public class IsValid extends Choreography {
	...
	*/
	public IsValid(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/TokenStorage/IsValid"));
	}
	...
	*/
	 ...
	 */
	@Override
	public IsValidResultSet run() {
		JSONObject result = super.runWithResults();
		return new IsValidResultSet(result);
	}
