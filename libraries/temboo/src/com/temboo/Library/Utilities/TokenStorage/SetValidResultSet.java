...
*/
public  class SetValidResultSet extends ResultSet {
		
	public SetValidResultSet(JSONObject doc) {
		super(doc);
	}
	...
	@return String - (boolean) Returns true if the operation was successful.
	*/
