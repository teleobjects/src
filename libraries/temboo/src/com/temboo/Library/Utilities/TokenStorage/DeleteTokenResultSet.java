...
*/
public  class DeleteTokenResultSet extends ResultSet {
		
	public DeleteTokenResultSet(JSONObject doc) {
		super(doc);
	}
	...
	@return String - (boolean) Returns true when token is successfully deleted.
	*/
