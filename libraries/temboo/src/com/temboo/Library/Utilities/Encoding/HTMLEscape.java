...
public class HTMLEscape extends Choreography {
	...
	*/
	public HTMLEscape(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Encoding/HTMLEscape"));
	}
	...
	*/
	public void setUnescapedHTML(String value) {
		this.inputs.setInput("UnescapedHTML", value);
	}
	 ...
	 */
	@Override
	public HTMLEscapeResultSet run() {
		JSONObject result = super.runWithResults();
		return new HTMLEscapeResultSet(result);
	}
