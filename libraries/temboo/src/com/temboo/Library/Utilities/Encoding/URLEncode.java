...
public class URLEncode extends Choreography {
	...
	*/
	public URLEncode(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/Encoding/URLEncode"));
	}
	...
	*/
	 ...
	 */
	@Override
	public URLEncodeResultSet run() {
		JSONObject result = super.runWithResults();
		return new URLEncodeResultSet(result);
	}
