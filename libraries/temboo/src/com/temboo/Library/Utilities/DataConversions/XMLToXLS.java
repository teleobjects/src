...
*/
public class XMLToXLS extends Choreography {

	/**
	Create a new instance of the XMLToXLS Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public XMLToXLS(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Utilities/DataConversions/XMLToXLS"));
	}
	...
	*/
	 ...
	 */
	@Override
	public XMLToXLSResultSet run() {
		JSONObject result = super.runWithResults();
		return new XMLToXLSResultSet(result);
	}
