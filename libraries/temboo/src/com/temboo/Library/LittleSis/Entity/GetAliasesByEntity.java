...
*/
public class GetAliasesByEntity extends Choreography {

	/**
	Create a new instance of the GetAliasesByEntity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAliasesByEntity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LittleSis/Entity/GetAliasesByEntity"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID of the Entity (person or organization) for which aliases are to be retrieved.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetAliasesByEntityResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAliasesByEntityResultSet(result);
	}
