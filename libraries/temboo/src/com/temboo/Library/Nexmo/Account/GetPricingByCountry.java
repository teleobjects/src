...
*/
public class GetPricingByCountry extends Choreography {

	/**
	Create a new instance of the GetPricingByCountry Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPricingByCountry(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Nexmo/Account/GetPricingByCountry"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPricingByCountryResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPricingByCountryResultSet(result);
	}
