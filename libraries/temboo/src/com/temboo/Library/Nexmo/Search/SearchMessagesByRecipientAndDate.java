...
*/
public class SearchMessagesByRecipientAndDate extends Choreography {

	/**
	Create a new instance of the SearchMessagesByRecipientAndDate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SearchMessagesByRecipientAndDate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Nexmo/Search/SearchMessagesByRecipientAndDate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchMessagesByRecipientAndDateResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchMessagesByRecipientAndDateResultSet(result);
	}
