...
*/
public class LeadershipPACs extends Choreography {

	/**
	Create a new instance of the LeadershipPACs Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LeadershipPACs(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Committees/LeadershipPACs"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LeadershipPACsResultSet run() {
		JSONObject result = super.runWithResults();
		return new LeadershipPACsResultSet(result);
	}
