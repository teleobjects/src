...
*/
public class CommitteeDetails extends Choreography {

	/**
	Create a new instance of the CommitteeDetails Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CommitteeDetails(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Committees/CommitteeDetails"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CommitteeDetailsResultSet run() {
		JSONObject result = super.runWithResults();
		return new CommitteeDetailsResultSet(result);
	}
