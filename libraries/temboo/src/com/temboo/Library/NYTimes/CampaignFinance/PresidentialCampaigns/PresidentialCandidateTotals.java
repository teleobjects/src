...
*/
public class PresidentialCandidateTotals extends Choreography {

	/**
	Create a new instance of the PresidentialCandidateTotals Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PresidentialCandidateTotals(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/PresidentialCampaigns/PresidentialCandidateTotals"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PresidentialCandidateTotalsResultSet run() {
		JSONObject result = super.runWithResults();
		return new PresidentialCandidateTotalsResultSet(result);
	}
