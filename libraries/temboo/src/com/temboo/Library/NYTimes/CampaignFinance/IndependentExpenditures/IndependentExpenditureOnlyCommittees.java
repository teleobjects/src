...
*/
public class IndependentExpenditureOnlyCommittees extends Choreography {
	...
	*/
	public IndependentExpenditureOnlyCommittees(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/IndependentExpenditures/IndependentExpenditureOnlyCommittees"));
	}
	...
	*/
	 ...
	 */
	@Override
	public IndependentExpenditureOnlyCommitteesResultSet run() {
		JSONObject result = super.runWithResults();
		return new IndependentExpenditureOnlyCommitteesResultSet(result);
	}
