...
*/
public class CommitteeFilings extends Choreography {

	/**
	Create a new instance of the CommitteeFilings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CommitteeFilings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Committees/CommitteeFilings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CommitteeFilingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new CommitteeFilingsResultSet(result);
	}
