...
*/
public class CommitteeContributions extends Choreography {

	/**
	Create a new instance of the CommitteeContributions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CommitteeContributions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Committees/CommitteeContributions"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CommitteeContributionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new CommitteeContributionsResultSet(result);
	}
