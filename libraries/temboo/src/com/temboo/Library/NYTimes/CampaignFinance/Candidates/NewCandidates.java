...
*/
public class NewCandidates extends Choreography {

	/**
	Create a new instance of the NewCandidates Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public NewCandidates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Candidates/NewCandidates"));
	}
	...
	*/
	 ...
	 */
	@Override
	public NewCandidatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new NewCandidatesResultSet(result);
	}
