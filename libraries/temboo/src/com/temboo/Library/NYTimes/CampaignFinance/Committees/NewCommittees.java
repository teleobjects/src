...
*/
public class NewCommittees extends Choreography {

	/**
	Create a new instance of the NewCommittees Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public NewCommittees(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/CampaignFinance/Committees/NewCommittees"));
	}
	...
	*/
	 ...
	 */
	@Override
	public NewCommitteesResultSet run() {
		JSONObject result = super.runWithResults();
		return new NewCommitteesResultSet(result);
	}
