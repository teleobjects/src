...
*/
public class GetMostViewed extends Choreography {

	/**
	Create a new instance of the GetMostViewed Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMostViewed(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NYTimes/MostPopular/GetMostViewed"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMostViewedResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMostViewedResultSet(result);
	}
