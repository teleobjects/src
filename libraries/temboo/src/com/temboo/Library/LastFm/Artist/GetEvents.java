...
public class GetEvents extends Choreography {
	...
	*/
	public GetEvents(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/Artist/GetEvents"));
	}
	...
	*/
	...
	@param String - (optional, boolean) Whether only festivals should be returned, or all events. Defaults to 0 (false).
	*/
