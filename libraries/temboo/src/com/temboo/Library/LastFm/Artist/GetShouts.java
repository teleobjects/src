...
*/
public class GetShouts extends Choreography {

	/**
	Create a new instance of the GetShouts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetShouts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/Artist/GetShouts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetShoutsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetShoutsResultSet(result);
	}
