...
*/
public class GetSimilar extends Choreography {

	/**
	Create a new instance of the GetSimilar Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSimilar(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/Artist/GetSimilar"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSimilarResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSimilarResultSet(result);
	}
