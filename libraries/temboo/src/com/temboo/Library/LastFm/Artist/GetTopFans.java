...
*/
public class GetTopFans extends Choreography {

	/**
	Create a new instance of the GetTopFans Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTopFans(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/Artist/GetTopFans"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTopFansResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTopFansResultSet(result);
	}
