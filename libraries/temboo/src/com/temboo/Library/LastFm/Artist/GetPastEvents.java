...
*/
public class GetPastEvents extends Choreography {

	/**
	Create a new instance of the GetPastEvents Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPastEvents(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/Artist/GetPastEvents"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPastEventsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPastEventsResultSet(result);
	}
