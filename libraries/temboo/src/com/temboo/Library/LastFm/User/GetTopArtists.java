...
*/
public class GetTopArtists extends Choreography {

	/**
	Create a new instance of the GetTopArtists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTopArtists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/User/GetTopArtists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTopArtistsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTopArtistsResultSet(result);
	}
