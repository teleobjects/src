...
*/
public class GetEvents extends Choreography {

	/**
	Create a new instance of the GetEvents Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEvents(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/User/GetEvents"));
	}
	...
	*/
	public void setFestivalsOnly(Boolean value) {
		this.inputs.setInput("FestivalsOnly", value);
	}

	/** 
	Set the value of the FestivalsOnly input for this Choreo as a String. 

	@param String - (optional, boolean) Whether only festivals should be returned, or all events. Defaults to 0 to return all events.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetEventsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEventsResultSet(result);
	}
