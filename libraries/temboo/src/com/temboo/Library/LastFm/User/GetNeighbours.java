...
*/
public class GetNeighbours extends Choreography {

	/**
	Create a new instance of the GetNeighbours Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetNeighbours(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/User/GetNeighbours"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetNeighboursResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetNeighboursResultSet(result);
	}
