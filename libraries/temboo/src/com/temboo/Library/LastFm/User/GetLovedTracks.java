...
*/
public class GetLovedTracks extends Choreography {

	/**
	Create a new instance of the GetLovedTracks Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLovedTracks(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/User/GetLovedTracks"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLovedTracksResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLovedTracksResultSet(result);
	}
