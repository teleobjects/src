...
*/
public class GetWeeklyTrackChart extends Choreography {

	/**
	Create a new instance of the GetWeeklyTrackChart Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWeeklyTrackChart(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LastFm/User/GetWeeklyTrackChart"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWeeklyTrackChartResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWeeklyTrackChartResultSet(result);
	}
