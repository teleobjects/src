...
*/
public class ListMyPlaylists extends Choreography {

	/**
	Create a new instance of the ListMyPlaylists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMyPlaylists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Playlists/ListMyPlaylists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMyPlaylistsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMyPlaylistsResultSet(result);
	}
