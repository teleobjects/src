...
*/
public class ListPlaylistsByChannel extends Choreography {

	/**
	Create a new instance of the ListPlaylistsByChannel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListPlaylistsByChannel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Playlists/ListPlaylistsByChannel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListPlaylistsByChannelResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPlaylistsByChannelResultSet(result);
	}
