...
*/
public class ListChannelsByID extends Choreography {

	/**
	Create a new instance of the ListChannelsByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListChannelsByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Channels/ListChannelsByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListChannelsByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListChannelsByIDResultSet(result);
	}
