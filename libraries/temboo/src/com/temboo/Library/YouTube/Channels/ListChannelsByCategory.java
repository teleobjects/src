...
*/
public class ListChannelsByCategory extends Choreography {

	/**
	Create a new instance of the ListChannelsByCategory Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListChannelsByCategory(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Channels/ListChannelsByCategory"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListChannelsByCategoryResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListChannelsByCategoryResultSet(result);
	}
