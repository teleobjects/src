...
*/
public class ListMyChannels extends Choreography {

	/**
	Create a new instance of the ListMyChannels Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMyChannels(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Channels/ListMyChannels"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMyChannelsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMyChannelsResultSet(result);
	}
