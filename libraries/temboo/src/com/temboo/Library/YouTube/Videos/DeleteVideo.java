...
*/
public class DeleteVideo extends Choreography {

	/**
	Create a new instance of the DeleteVideo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteVideo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Videos/DeleteVideo"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteVideoResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteVideoResultSet(result);
	}
