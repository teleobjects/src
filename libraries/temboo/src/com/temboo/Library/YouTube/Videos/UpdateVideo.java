...
*/
public class UpdateVideo extends Choreography {

	/**
	Create a new instance of the UpdateVideo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateVideo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Videos/UpdateVideo"));
	}

	/** 
	Set the value of the VideoMetadata input for this Choreo. 

	@param String - (required, json) A JSON representation of the video resource containing fields to update. The id key for the video is required for updates. See documentation for examples.
	*/
	public void setVideoMetadata(String value) {
		this.inputs.setInput("VideoMetadata", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateVideoResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateVideoResultSet(result);
	}
