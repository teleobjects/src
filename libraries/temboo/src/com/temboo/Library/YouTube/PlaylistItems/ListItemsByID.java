...
*/
public class ListItemsByID extends Choreography {

	/**
	Create a new instance of the ListItemsByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListItemsByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/PlaylistItems/ListItemsByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListItemsByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListItemsByIDResultSet(result);
	}
