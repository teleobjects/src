...
*/
public class ListCategoriesByID extends Choreography {

	/**
	Create a new instance of the ListCategoriesByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCategoriesByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/VideoCategories/ListCategoriesByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCategoriesByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCategoriesByIDResultSet(result);
	}
