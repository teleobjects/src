...
*/
public class ListSubscriptionsByChannel extends Choreography {

	/**
	Create a new instance of the ListSubscriptionsByChannel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSubscriptionsByChannel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Subscriptions/ListSubscriptionsByChannel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSubscriptionsByChannelResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSubscriptionsByChannelResultSet(result);
	}
