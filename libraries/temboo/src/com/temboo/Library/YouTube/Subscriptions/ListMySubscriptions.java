...
*/
public class ListMySubscriptions extends Choreography {

	/**
	Create a new instance of the ListMySubscriptions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMySubscriptions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Subscriptions/ListMySubscriptions"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMySubscriptionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMySubscriptionsResultSet(result);
	}
