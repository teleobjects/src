...
*/
public class SubscribeToChannel extends Choreography {

	/**
	Create a new instance of the SubscribeToChannel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SubscribeToChannel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Subscriptions/SubscribeToChannel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SubscribeToChannelResultSet run() {
		JSONObject result = super.runWithResults();
		return new SubscribeToChannelResultSet(result);
	}
