...
*/
public class ListHomePageActivities extends Choreography {

	/**
	Create a new instance of the ListHomePageActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListHomePageActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Activities/ListHomePageActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListHomePageActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListHomePageActivitiesResultSet(result);
	}
