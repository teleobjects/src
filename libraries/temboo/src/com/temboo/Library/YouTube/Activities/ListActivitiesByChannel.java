...
*/
public class ListActivitiesByChannel extends Choreography {

	/**
	Create a new instance of the ListActivitiesByChannel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListActivitiesByChannel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/Activities/ListActivitiesByChannel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListActivitiesByChannelResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListActivitiesByChannelResultSet(result);
	}
