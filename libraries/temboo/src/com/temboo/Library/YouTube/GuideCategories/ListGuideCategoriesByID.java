...
*/
public class ListGuideCategoriesByID extends Choreography {

	/**
	Create a new instance of the ListGuideCategoriesByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGuideCategoriesByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/GuideCategories/ListGuideCategoriesByID"));
	}
	...
	*/
	public void setGuideCategoryID(String value) {
		this.inputs.setInput("GuideCategoryID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGuideCategoriesByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGuideCategoriesByIDResultSet(result);
	}
