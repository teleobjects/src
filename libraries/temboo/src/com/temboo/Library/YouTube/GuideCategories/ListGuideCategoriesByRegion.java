...
*/
public class ListGuideCategoriesByRegion extends Choreography {

	/**
	Create a new instance of the ListGuideCategoriesByRegion Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGuideCategoriesByRegion(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/YouTube/GuideCategories/ListGuideCategoriesByRegion"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGuideCategoriesByRegionResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGuideCategoriesByRegionResultSet(result);
	}
