...
*/
public class DeleteInvalidAddress extends Choreography {

	/**
	Create a new instance of the DeleteInvalidAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteInvalidAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/InvalidEmails/DeleteInvalidAddress"));
	}
	...
	*/
	public void setEmailAddressToDelete(String value) {
		this.inputs.setInput("EmailAddressToDelete", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteInvalidAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteInvalidAddressResultSet(result);
	}
