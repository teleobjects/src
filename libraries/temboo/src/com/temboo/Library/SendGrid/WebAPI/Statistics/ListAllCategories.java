...
*/
public class ListAllCategories extends Choreography {

	/**
	Create a new instance of the ListAllCategories Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllCategories(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Statistics/ListAllCategories"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllCategoriesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllCategoriesResultSet(result);
	}
