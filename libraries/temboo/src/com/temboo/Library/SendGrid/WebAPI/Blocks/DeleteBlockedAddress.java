package com.temboo.Library.SendGrid.WebAPI.Blocks;
...
*/
public class DeleteBlockedAddress extends Choreography {

	/**
	Create a new instance of the DeleteBlockedAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBlockedAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Blocks/DeleteBlockedAddress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBlockedAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBlockedAddressResultSet(result);
	}
