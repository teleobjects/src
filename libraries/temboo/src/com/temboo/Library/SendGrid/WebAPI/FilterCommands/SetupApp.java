...
public class SetupApp extends Choreography {
	...
	*/
	public SetupApp(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/FilterCommands/SetupApp"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SetupAppResultSet run() {
		JSONObject result = super.runWithResults();
		return new SetupAppResultSet(result);
	}
