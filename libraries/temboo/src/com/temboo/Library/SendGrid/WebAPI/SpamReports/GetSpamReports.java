...
*/
public class GetSpamReports extends Choreography {

	/**
	Create a new instance of the GetSpamReports Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSpamReports(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/SpamReports/GetSpamReports"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSpamReportsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSpamReportsResultSet(result);
	}
