...
*/
public class GetUnsubscribesList extends Choreography {

	/**
	Create a new instance of the GetUnsubscribesList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUnsubscribesList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Unsubscribes/GetUnsubscribesList"));
	}
	...
	*/
	...
	@param String - (optional, integer) A number to limit the number of results returned.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetUnsubscribesListResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUnsubscribesListResultSet(result);
	}
