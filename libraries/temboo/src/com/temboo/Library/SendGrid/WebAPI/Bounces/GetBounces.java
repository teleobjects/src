...
*/
public class GetBounces extends Choreography {

	/**
	Create a new instance of the GetBounces Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBounces(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Bounces/GetBounces"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBouncesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBouncesResultSet(result);
	}
