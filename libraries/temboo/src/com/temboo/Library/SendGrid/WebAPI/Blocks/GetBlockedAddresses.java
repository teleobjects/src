...
*/
public class GetBlockedAddresses extends Choreography {

	/**
	Create a new instance of the GetBlockedAddresses Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBlockedAddresses(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Blocks/GetBlockedAddresses"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBlockedAddressesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBlockedAddressesResultSet(result);
	}
