...
Deactivate an app.
*/
public class DeactivateApp extends Choreography {

	/**
	Create a new instance of the DeactivateApp Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeactivateApp(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/FilterCommands/DeactivateApp"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeactivateAppResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeactivateAppResultSet(result);
	}
