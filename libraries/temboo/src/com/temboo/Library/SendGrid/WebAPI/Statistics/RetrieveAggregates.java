...
*/
public class RetrieveAggregates extends Choreography {

	/**
	Create a new instance of the RetrieveAggregates Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveAggregates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Statistics/RetrieveAggregates"));
	}
	...
	*/
	public void setAggregate(Integer value) {
		this.inputs.setInput("Aggregate", value);
	}

	/** 
	Set the value of the Aggregate input for this Choreo as a String. 

	@param String - (required, integer) Retrieve all time totals. Must be set to 1. 
	*/
	...
	*/
	 ...
	 */
	@Override
	public RetrieveAggregatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveAggregatesResultSet(result);
	}
