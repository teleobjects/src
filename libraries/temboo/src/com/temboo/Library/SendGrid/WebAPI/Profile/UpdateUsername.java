...
*/
public class UpdateUsername extends Choreography {

	/**
	Create a new instance of the UpdateUsername Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateUsername(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/Profile/UpdateUsername"));
	}
	...
	*/
	public void setNewUsername(String value) {
		this.inputs.setInput("NewUsername", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateUsernameResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateUsernameResultSet(result);
	}
