...
*/
public class GetAppSettings extends Choreography {

	/**
	Create a new instance of the GetAppSettings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAppSettings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/WebAPI/FilterCommands/GetAppSettings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAppSettingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAppSettingsResultSet(result);
	}
