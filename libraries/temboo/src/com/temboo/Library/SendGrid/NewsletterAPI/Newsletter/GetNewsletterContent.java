...
*/
public class GetNewsletterContent extends Choreography {

	/**
	Create a new instance of the GetNewsletterContent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetNewsletterContent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Newsletter/GetNewsletterContent"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetNewsletterContentResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetNewsletterContentResultSet(result);
	}
