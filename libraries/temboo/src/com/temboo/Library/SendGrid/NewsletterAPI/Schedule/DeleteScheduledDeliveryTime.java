...
*/
public class DeleteScheduledDeliveryTime extends Choreography {

	/**
	Create a new instance of the DeleteScheduledDeliveryTime Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteScheduledDeliveryTime(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Schedule/DeleteScheduledDeliveryTime"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteScheduledDeliveryTimeResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteScheduledDeliveryTimeResultSet(result);
	}
