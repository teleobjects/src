...
*/
public class DeleteNewsletter extends Choreography {

	/**
	Create a new instance of the DeleteNewsletter Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteNewsletter(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Newsletter/DeleteNewsletter"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteNewsletterResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteNewsletterResultSet(result);
	}
