...
*/
public class GetAttachedRecipientLists extends Choreography {

	/**
	Create a new instance of the GetAttachedRecipientLists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAttachedRecipientLists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Recipients/GetAttachedRecipientLists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAttachedRecipientListsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAttachedRecipientListsResultSet(result);
	}
