...
public class DeleteEmailFromList extends Choreography {
	...
	*/
	public DeleteEmailFromList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/ListsEmail/DeleteEmailFromList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteEmailFromListResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteEmailFromListResultSet(result);
	}
