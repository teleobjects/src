...
*/
public class RenameRecipientList extends Choreography {

	/**
	Create a new instance of the RenameRecipientList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RenameRecipientList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Lists/RenameRecipientList"));
	}
	...
	*/
	public void setNewList(String value) {
		this.inputs.setInput("NewList", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public RenameRecipientListResultSet run() {
		JSONObject result = super.runWithResults();
		return new RenameRecipientListResultSet(result);
	}
