...
*/
public class EditNewsletter extends Choreography {

	/**
	Create a new instance of the EditNewsletter Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditNewsletter(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Newsletter/EditNewsletter"));
	}
	...
	*/
	public void setNewName(String value) {
		this.inputs.setInput("NewName", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public EditNewsletterResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditNewsletterResultSet(result);
	}
