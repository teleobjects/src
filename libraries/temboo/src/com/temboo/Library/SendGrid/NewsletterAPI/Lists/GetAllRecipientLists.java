...
*/
public class GetAllRecipientLists extends Choreography {

	/**
	Create a new instance of the GetAllRecipientLists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllRecipientLists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/Lists/GetAllRecipientLists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAllRecipientListsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllRecipientListsResultSet(result);
	}
