...
*/
public class GetListEmailAddresses extends Choreography {

	/**
	Create a new instance of the GetListEmailAddresses Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetListEmailAddresses(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SendGrid/NewsletterAPI/ListsEmail/GetListEmailAddresses"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetListEmailAddressesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetListEmailAddressesResultSet(result);
	}
