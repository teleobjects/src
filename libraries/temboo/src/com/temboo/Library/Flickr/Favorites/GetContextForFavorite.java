...
*/
public class GetContextForFavorite extends Choreography {

	/**
	Create a new instance of the GetContextForFavorite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetContextForFavorite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Favorites/GetContextForFavorite"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo to fetch the context for.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetContextForFavoriteResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetContextForFavoriteResultSet(result);
	}
