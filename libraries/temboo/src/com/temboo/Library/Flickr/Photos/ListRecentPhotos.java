...
*/
public class ListRecentPhotos extends Choreography {

	/**
	Create a new instance of the ListRecentPhotos Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRecentPhotos(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Photos/ListRecentPhotos"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRecentPhotosResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRecentPhotosResultSet(result);
	}
