...
*/
public class MakeUserIdentityThePrimary extends Choreography {

	/**
	Create a new instance of the MakeUserIdentityThePrimary Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MakeUserIdentityThePrimary(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/MakeUserIdentityThePrimary"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MakeUserIdentityThePrimaryResultSet run() {
		JSONObject result = super.runWithResults();
		return new MakeUserIdentityThePrimaryResultSet(result);
	}
