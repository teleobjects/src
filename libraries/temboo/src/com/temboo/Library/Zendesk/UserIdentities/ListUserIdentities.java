...
*/
public class ListUserIdentities extends Choreography {

	/**
	Create a new instance of the ListUserIdentities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListUserIdentities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/ListUserIdentities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListUserIdentitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListUserIdentitiesResultSet(result);
	}
