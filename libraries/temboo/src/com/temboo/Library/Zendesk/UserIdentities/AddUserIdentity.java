...
*/
public class AddUserIdentity extends Choreography {

	/**
	Create a new instance of the AddUserIdentity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddUserIdentity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/AddUserIdentity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AddUserIdentityResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddUserIdentityResultSet(result);
	}
