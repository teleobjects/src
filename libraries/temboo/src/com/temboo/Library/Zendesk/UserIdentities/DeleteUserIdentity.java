...
*/
public class DeleteUserIdentity extends Choreography {

	/**
	Create a new instance of the DeleteUserIdentity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteUserIdentity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/DeleteUserIdentity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteUserIdentityResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteUserIdentityResultSet(result);
	}
