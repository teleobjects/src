...
*/
public class ShowUserIdentity extends Choreography {

	/**
	Create a new instance of the ShowUserIdentity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowUserIdentity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/ShowUserIdentity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowUserIdentityResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowUserIdentityResultSet(result);
	}
