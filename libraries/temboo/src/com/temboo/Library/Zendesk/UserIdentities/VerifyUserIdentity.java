...
*/
public class VerifyUserIdentity extends Choreography {

	/**
	Create a new instance of the VerifyUserIdentity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VerifyUserIdentity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/VerifyUserIdentity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public VerifyUserIdentityResultSet run() {
		JSONObject result = super.runWithResults();
		return new VerifyUserIdentityResultSet(result);
	}
