...
*/
public class RequestUserVerification extends Choreography {

	/**
	Create a new instance of the RequestUserVerification Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RequestUserVerification(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/UserIdentities/RequestUserVerification"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RequestUserVerificationResultSet run() {
		JSONObject result = super.runWithResults();
		return new RequestUserVerificationResultSet(result);
	}
