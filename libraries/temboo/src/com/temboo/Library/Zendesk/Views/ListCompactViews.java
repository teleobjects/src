...
*/
public class ListCompactViews extends Choreography {

	/**
	Create a new instance of the ListCompactViews Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCompactViews(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/ListCompactViews"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCompactViewsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCompactViewsResultSet(result);
	}
