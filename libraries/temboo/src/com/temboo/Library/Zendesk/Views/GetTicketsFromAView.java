...
*/
public class GetTicketsFromAView extends Choreography {

	/**
	Create a new instance of the GetTicketsFromAView Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTicketsFromAView(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/GetTicketsFromAView"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTicketsFromAViewResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTicketsFromAViewResultSet(result);
	}
