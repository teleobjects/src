...
Creates a new view.
*/
public class CreateView extends Choreography {

	/**
	Create a new instance of the CreateView Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateView(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/CreateView"));
	}
	...
	*/
	public void setAllConditions(String value) {
		this.inputs.setInput("AllConditions", value);
	}
	...
	*/
	public void setAnyConditions(String value) {
		this.inputs.setInput("AnyConditions", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateViewResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateViewResultSet(result);
	}
