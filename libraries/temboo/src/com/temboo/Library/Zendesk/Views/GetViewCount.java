...
*/
public class GetViewCount extends Choreography {

	/**
	Create a new instance of the GetViewCount Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetViewCount(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/GetViewCount"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetViewCountResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetViewCountResultSet(result);
	}
