...
*/
public class ListViews extends Choreography {

	/**
	Create a new instance of the ListViews Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListViews(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/ListViews"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListViewsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListViewsResultSet(result);
	}
