...
*/
public class DeleteView extends Choreography {

	/**
	Create a new instance of the DeleteView Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteView(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/DeleteView"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteViewResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteViewResultSet(result);
	}
