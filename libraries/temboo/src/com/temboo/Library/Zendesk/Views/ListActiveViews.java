...
*/
public class ListActiveViews extends Choreography {

	/**
	Create a new instance of the ListActiveViews Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListActiveViews(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/ListActiveViews"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListActiveViewsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListActiveViewsResultSet(result);
	}
