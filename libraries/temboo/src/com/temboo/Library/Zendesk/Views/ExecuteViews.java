...
*/
public class ExecuteViews extends Choreography {

	/**
	Create a new instance of the ExecuteViews Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ExecuteViews(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Views/ExecuteViews"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ExecuteViewsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ExecuteViewsResultSet(result);
	}
