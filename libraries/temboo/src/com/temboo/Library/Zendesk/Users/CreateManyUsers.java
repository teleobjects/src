...
*/
public class CreateManyUsers extends Choreography {

	/**
	Create a new instance of the CreateManyUsers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateManyUsers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/CreateManyUsers"));
	}
	...
	*/
	public void setUsers(String value) {
		this.inputs.setInput("Users", value);
	}
	 ...
	 */
	@Override
	public CreateManyUsersResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateManyUsersResultSet(result);
	}
