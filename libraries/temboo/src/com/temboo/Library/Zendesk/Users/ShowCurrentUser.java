...
*/
public class ShowCurrentUser extends Choreography {

	/**
	Create a new instance of the ShowCurrentUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowCurrentUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/ShowCurrentUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowCurrentUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowCurrentUserResultSet(result);
	}
