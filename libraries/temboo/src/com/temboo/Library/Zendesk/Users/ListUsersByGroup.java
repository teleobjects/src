...
*/
public class ListUsersByGroup extends Choreography {

	/**
	Create a new instance of the ListUsersByGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListUsersByGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/ListUsersByGroup"));
	}
	...
	*/
	...
	/** 
	Set the value of the GroupID input for this Choreo as a String. 

	@param String - (required, integer) The ID number of the group.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListUsersByGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListUsersByGroupResultSet(result);
	}
