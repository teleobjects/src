...
*/
public class SuspendUser extends Choreography {

	/**
	Create a new instance of the SuspendUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SuspendUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/SuspendUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SuspendUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new SuspendUserResultSet(result);
	}
