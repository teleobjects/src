...
*/
public class ListAllUsers extends Choreography {

	/**
	Create a new instance of the ListAllUsers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllUsers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/ListAllUsers"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllUsersResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllUsersResultSet(result);
	}
