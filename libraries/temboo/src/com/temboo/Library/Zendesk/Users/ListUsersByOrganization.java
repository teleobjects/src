...
*/
public class ListUsersByOrganization extends Choreography {

	/**
	Create a new instance of the ListUsersByOrganization Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListUsersByOrganization(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Users/ListUsersByOrganization"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListUsersByOrganizationResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListUsersByOrganizationResultSet(result);
	}
