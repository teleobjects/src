...
public class ListMacros extends Choreography {
	...
	*/
	public ListMacros(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Macros/ListMacros"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMacrosResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMacrosResultSet(result);
	}
