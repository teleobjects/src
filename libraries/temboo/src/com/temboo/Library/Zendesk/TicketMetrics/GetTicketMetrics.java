...
*/
public class GetTicketMetrics extends Choreography {

	/**
	Create a new instance of the GetTicketMetrics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTicketMetrics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketMetrics/GetTicketMetrics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTicketMetricsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTicketMetricsResultSet(result);
	}
