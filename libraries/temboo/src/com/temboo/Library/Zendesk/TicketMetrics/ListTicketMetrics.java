...
*/
public class ListTicketMetrics extends Choreography {

	/**
	Create a new instance of the ListTicketMetrics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTicketMetrics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketMetrics/ListTicketMetrics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListTicketMetricsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTicketMetricsResultSet(result);
	}
