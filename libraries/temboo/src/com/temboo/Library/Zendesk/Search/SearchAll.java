...
*/
public class SearchAll extends Choreography {

	/**
	Create a new instance of the SearchAll Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SearchAll(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Search/SearchAll"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchAllResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchAllResultSet(result);
	}
