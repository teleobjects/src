...
*/
public class ListGroups extends Choreography {

	/**
	Create a new instance of the ListGroups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListGroups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Groups/ListGroups"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListGroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListGroupsResultSet(result);
	}
