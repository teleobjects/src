...
*/
public class DeleteGroup extends Choreography {

	/**
	Create a new instance of the DeleteGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Groups/DeleteGroup"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteGroupResultSet(result);
	}
