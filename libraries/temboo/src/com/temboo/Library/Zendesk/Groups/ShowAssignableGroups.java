...
*/
public class ShowAssignableGroups extends Choreography {

	/**
	Create a new instance of the ShowAssignableGroups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowAssignableGroups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Groups/ShowAssignableGroups"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowAssignableGroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowAssignableGroupsResultSet(result);
	}
