...
*/
public class AutocompleteOrganizationName extends Choreography {

	/**
	Create a new instance of the AutocompleteOrganizationName Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AutocompleteOrganizationName(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/AutocompleteOrganizationName"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AutocompleteOrganizationNameResultSet run() {
		JSONObject result = super.runWithResults();
		return new AutocompleteOrganizationNameResultSet(result);
	}
