...
*/
public class ListOrganizations extends Choreography {

	/**
	Create a new instance of the ListOrganizations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListOrganizations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/ListOrganizations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListOrganizationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListOrganizationsResultSet(result);
	}
