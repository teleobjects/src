...
*/
public class CreateOrganization extends Choreography {

	/**
	Create a new instance of the CreateOrganization Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateOrganization(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/CreateOrganization"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateOrganizationResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateOrganizationResultSet(result);
	}
