...
*/
public class DeleteOrganization extends Choreography {

	/**
	Create a new instance of the DeleteOrganization Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteOrganization(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/DeleteOrganization"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteOrganizationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteOrganizationResultSet(result);
	}
