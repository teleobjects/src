...
*/
public class GetOrganization extends Choreography {

	/**
	Create a new instance of the GetOrganization Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetOrganization(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/GetOrganization"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetOrganizationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetOrganizationResultSet(result);
	}
