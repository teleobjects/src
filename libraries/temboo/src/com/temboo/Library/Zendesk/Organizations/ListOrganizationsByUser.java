...
*/
public class ListOrganizationsByUser extends Choreography {

	/**
	Create a new instance of the ListOrganizationsByUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListOrganizationsByUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Organizations/ListOrganizationsByUser"));
	}
	...
	*/
	...
	@param String - (optional, integer) The page number of the results to be returned. Used together with the Number parameter to paginate a large set of results.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListOrganizationsByUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListOrganizationsByUserResultSet(result);
	}
