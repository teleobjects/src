...
*/
public class DeleteTicket extends Choreography {

	/**
	Create a new instance of the DeleteTicket Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteTicket(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/DeleteTicket"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteTicketResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteTicketResultSet(result);
	}
