...
*/
public class ListTicketsByUser extends Choreography {

	/**
	Create a new instance of the ListTicketsByUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTicketsByUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/ListTicketsByUser"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID number of the user.
	*/
	...
	*/
	public void setUserType(String value) {
		this.inputs.setInput("UserType", value);
	}
	 ...
	 */
	@Override
	public ListTicketsByUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTicketsByUserResultSet(result);
	}
