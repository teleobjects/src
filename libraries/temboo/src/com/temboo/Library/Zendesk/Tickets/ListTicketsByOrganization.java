...
*/
public class ListTicketsByOrganization extends Choreography {

	/**
	Create a new instance of the ListTicketsByOrganization Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTicketsByOrganization(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/ListTicketsByOrganization"));
	}
	...
	*/
	public void setOrganizationID(Integer value) {
		this.inputs.setInput("OrganizationID", value);
	}

	/** 
	Set the value of the OrganizationID input for this Choreo as a String. 

	@param String - (required, integer) The ID number of the organization.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListTicketsByOrganizationResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTicketsByOrganizationResultSet(result);
	}
