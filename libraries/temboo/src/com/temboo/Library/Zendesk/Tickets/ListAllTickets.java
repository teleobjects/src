...
*/
public class ListAllTickets extends Choreography {

	/**
	Create a new instance of the ListAllTickets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllTickets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/ListAllTickets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllTicketsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllTicketsResultSet(result);
	}
