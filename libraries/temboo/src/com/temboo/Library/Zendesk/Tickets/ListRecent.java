...
*/
public class ListRecent extends Choreography {

	/**
	Create a new instance of the ListRecent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListRecent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/ListRecent"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListRecentResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListRecentResultSet(result);
	}
