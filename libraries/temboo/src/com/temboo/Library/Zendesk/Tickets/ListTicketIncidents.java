...
*/
public class ListTicketIncidents extends Choreography {

	/**
	Create a new instance of the ListTicketIncidents Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTicketIncidents(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Tickets/ListTicketIncidents"));
	}
	...
	*/
	...
	@param String - (conditional, integer) The number of results to return per page. Maximum is 100 and default is 100.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListTicketIncidentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTicketIncidentsResultSet(result);
	}
