...
public class GetRequest extends Choreography {
	...
	*/
	public GetRequest(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Requests/GetRequest"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRequestResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRequestResultSet(result);
	}
