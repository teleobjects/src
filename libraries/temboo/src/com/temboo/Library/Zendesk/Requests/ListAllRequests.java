...
*/
public class ListAllRequests extends Choreography {

	/**
	Create a new instance of the ListAllRequests Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllRequests(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/Requests/ListAllRequests"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllRequestsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllRequestsResultSet(result);
	}
