...
*/
public class GetMonitoredTwitterHandle extends Choreography {

	/**
	Create a new instance of the GetMonitoredTwitterHandle Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMonitoredTwitterHandle(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/MonitoredTwitterHandles/GetMonitoredTwitterHandle"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMonitoredTwitterHandleResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMonitoredTwitterHandleResultSet(result);
	}
