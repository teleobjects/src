...
*/
public class ListMonitoredTwitterHandles extends Choreography {

	/**
	Create a new instance of the ListMonitoredTwitterHandles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMonitoredTwitterHandles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/MonitoredTwitterHandles/ListMonitoredTwitterHandles"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMonitoredTwitterHandlesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMonitoredTwitterHandlesResultSet(result);
	}
