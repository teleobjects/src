...
public class ListActivity extends Choreography {
	...
	*/
	public ListActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/ActivityStream/ListActivity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListActivityResultSet(result);
	}
