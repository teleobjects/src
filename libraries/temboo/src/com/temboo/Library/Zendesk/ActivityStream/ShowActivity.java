...
*/
public class ShowActivity extends Choreography {

	/**
	Create a new instance of the ShowActivity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/ActivityStream/ShowActivity"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowActivityResultSet(result);
	}
