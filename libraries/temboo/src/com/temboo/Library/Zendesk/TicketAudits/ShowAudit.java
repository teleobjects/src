...
*/
public class ShowAudit extends Choreography {

	/**
	Create a new instance of the ShowAudit Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowAudit(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketAudits/ShowAudit"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowAuditResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowAuditResultSet(result);
	}
