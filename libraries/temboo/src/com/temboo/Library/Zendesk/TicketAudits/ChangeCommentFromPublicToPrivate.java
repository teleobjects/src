...
*/
public class ChangeCommentFromPublicToPrivate extends Choreography {

	/**
	Create a new instance of the ChangeCommentFromPublicToPrivate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ChangeCommentFromPublicToPrivate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketAudits/ChangeCommentFromPublicToPrivate"));
	}
	...
	*/
	public void setAuditID(String value) {
		this.inputs.setInput("AuditID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public ChangeCommentFromPublicToPrivateResultSet run() {
		JSONObject result = super.runWithResults();
		return new ChangeCommentFromPublicToPrivateResultSet(result);
	}
