...
*/
public class ListAudits extends Choreography {

	/**
	Create a new instance of the ListAudits Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAudits(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketAudits/ListAudits"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAuditsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAuditsResultSet(result);
	}
