...
*/
public class MarkAuditAsTrusted extends Choreography {

	/**
	Create a new instance of the MarkAuditAsTrusted Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MarkAuditAsTrusted(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zendesk/TicketAudits/MarkAuditAsTrusted"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MarkAuditAsTrustedResultSet run() {
		JSONObject result = super.runWithResults();
		return new MarkAuditAsTrustedResultSet(result);
	}
