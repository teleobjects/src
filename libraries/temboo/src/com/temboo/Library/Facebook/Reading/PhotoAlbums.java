...
*/
public class PhotoAlbums extends Choreography {

	/**
	Create a new instance of the PhotoAlbums Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PhotoAlbums(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/PhotoAlbums"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PhotoAlbumsResultSet run() {
		JSONObject result = super.runWithResults();
		return new PhotoAlbumsResultSet(result);
	}
