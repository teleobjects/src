...
*/
public class VideoTags extends Choreography {

	/**
	Create a new instance of the VideoTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VideoTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/VideoTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public VideoTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new VideoTagsResultSet(result);
	}
