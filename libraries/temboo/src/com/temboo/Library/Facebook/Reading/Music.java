...
*/
public class Music extends Choreography {

	/**
	Create a new instance of the Music Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Music(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Music"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MusicResultSet run() {
		JSONObject result = super.runWithResults();
		return new MusicResultSet(result);
	}
