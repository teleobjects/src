...
*/
public class Groups extends Choreography {

	/**
	Create a new instance of the Groups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Groups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Groups"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GroupsResultSet(result);
	}
