...
*/
public class Books extends Choreography {

	/**
	Create a new instance of the Books Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Books(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Books"));
	}
	...
	*/
	...
	@param String - (optional, string) The id of the user to retrieve books for. Defaults to "me" indicating the authenticated user.
	*/
	...
	*/
	 ...
	 */
	@Override
	public BooksResultSet run() {
		JSONObject result = super.runWithResults();
		return new BooksResultSet(result);
	}
