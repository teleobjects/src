...
*/
public class FriendLists extends Choreography {

	/**
	Create a new instance of the FriendLists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FriendLists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/FriendLists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FriendListsResultSet run() {
		JSONObject result = super.runWithResults();
		return new FriendListsResultSet(result);
	}
