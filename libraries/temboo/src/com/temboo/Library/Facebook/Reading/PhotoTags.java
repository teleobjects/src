...
*/
public class PhotoTags extends Choreography {

	/**
	Create a new instance of the PhotoTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PhotoTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/PhotoTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PhotoTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new PhotoTagsResultSet(result);
	}
