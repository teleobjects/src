...
*/
public class Events extends Choreography {

	/**
	Create a new instance of the Events Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Events(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Events"));
	}
	...
	*/
	...
	@param String - (optional, string) The event sub-category to return. Valid values are: attending, created, maybe, not_replied, or declined.
	*/
	...
	*/
	 ...
	 */
	@Override
	public EventsResultSet run() {
		JSONObject result = super.runWithResults();
		return new EventsResultSet(result);
	}
