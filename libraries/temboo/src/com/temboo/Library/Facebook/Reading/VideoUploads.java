...
*/
public class VideoUploads extends Choreography {

	/**
	Create a new instance of the VideoUploads Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VideoUploads(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/VideoUploads"));
	}
	...
	*/
	 ...
	 */
	@Override
	public VideoUploadsResultSet run() {
		JSONObject result = super.runWithResults();
		return new VideoUploadsResultSet(result);
	}
