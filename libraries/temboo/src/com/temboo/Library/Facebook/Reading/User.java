...
*/
public class User extends Choreography {

	/**
	Create a new instance of the User Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public User(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/User"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UserResultSet run() {
		JSONObject result = super.runWithResults();
		return new UserResultSet(result);
	}
