...
*/
public class Movies extends Choreography {

	/**
	Create a new instance of the Movies Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Movies(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Movies"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MoviesResultSet run() {
		JSONObject result = super.runWithResults();
		return new MoviesResultSet(result);
	}
