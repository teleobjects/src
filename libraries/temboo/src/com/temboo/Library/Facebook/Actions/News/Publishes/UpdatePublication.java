...
*/
public class UpdatePublication extends Choreography {

	/**
	Create a new instance of the UpdatePublication Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdatePublication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/News/Publishes/UpdatePublication"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdatePublicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdatePublicationResultSet(result);
	}
