...
*/
public class ReadActions extends Choreography {

	/**
	Create a new instance of the ReadActions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadActions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Custom/ReadActions"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadActionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadActionsResultSet(result);
	}
