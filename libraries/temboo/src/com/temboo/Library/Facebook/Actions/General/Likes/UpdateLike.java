...
*/
public class UpdateLike extends Choreography {

	/**
	Create a new instance of the UpdateLike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateLike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Likes/UpdateLike"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateLikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateLikeResultSet(result);
	}
