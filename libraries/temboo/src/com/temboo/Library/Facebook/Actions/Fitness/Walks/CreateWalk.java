...
*/
public class CreateWalk extends Choreography {

	/**
	Create a new instance of the CreateWalk Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateWalk(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Walks/CreateWalk"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateWalkResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateWalkResultSet(result);
	}
