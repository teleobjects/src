...
*/
public class CreateBike extends Choreography {

	/**
	Create a new instance of the CreateBike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateBike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Bikes/CreateBike"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateBikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateBikeResultSet(result);
	}
