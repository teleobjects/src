...
*/
public class CreatePlaylist extends Choreography {

	/**
	Create a new instance of the CreatePlaylist Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreatePlaylist(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Music/Playlists/CreatePlaylist"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreatePlaylistResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreatePlaylistResultSet(result);
	}
