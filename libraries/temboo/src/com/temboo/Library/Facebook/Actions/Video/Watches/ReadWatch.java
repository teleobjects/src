...
*/
public class ReadWatch extends Choreography {

	/**
	Create a new instance of the ReadWatch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadWatch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/Watches/ReadWatch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadWatchResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadWatchResultSet(result);
	}
