...
*/
public class CreateWatch extends Choreography {

	/**
	Create a new instance of the CreateWatch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateWatch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/Watches/CreateWatch"));
	}
	...
	*/
	public void setVideo(String value) {
		this.inputs.setInput("Video", value);
	}
	 ...
	 */
	@Override
	public CreateWatchResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateWatchResultSet(result);
	}
