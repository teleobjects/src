...
*/
public class ReadPlaylist extends Choreography {

	/**
	Create a new instance of the ReadPlaylist Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadPlaylist(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Music/Playlists/ReadPlaylist"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadPlaylistResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadPlaylistResultSet(result);
	}
