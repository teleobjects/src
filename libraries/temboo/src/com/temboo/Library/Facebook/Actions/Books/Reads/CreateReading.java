...
*/
public class CreateReading extends Choreography {

	/**
	Create a new instance of the CreateReading Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateReading(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Reads/CreateReading"));
	}
	...
	*/
	...
	@param String - (required, decimal) The percentage progress towards finishing the specified book.
	*/
	...
	*/
	 ...
	 */
	@Override
	public CreateReadingResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateReadingResultSet(result);
	}
