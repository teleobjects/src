...
*/
public class DeleteBike extends Choreography {

	/**
	Create a new instance of the DeleteBike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Bikes/DeleteBike"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBikeResultSet(result);
	}
