...
public class UpdateWatch extends Choreography {
	...
	*/
	public UpdateWatch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/Watches/UpdateWatch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateWatchResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateWatchResultSet(result);
	}
