...
*/
public class ReadWantsToWatch extends Choreography {

	/**
	Create a new instance of the ReadWantsToWatch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadWantsToWatch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/WantsToWatch/ReadWantsToWatch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadWantsToWatchResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadWantsToWatchResultSet(result);
	}
