...
*/
public class CreateLike extends Choreography {

	/**
	Create a new instance of the CreateLike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateLike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Likes/CreateLike"));
	}
	...
	*/
	...
	@param String - (optional, integer) The amount of time (in milleseconds) from the publish_time that the action will expire.
	*/
	...
	*/
	 ...
	 */
	@Override
	public CreateLikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateLikeResultSet(result);
	}
