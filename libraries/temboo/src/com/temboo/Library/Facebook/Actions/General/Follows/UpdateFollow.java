...
*/
public class UpdateFollow extends Choreography {

	/**
	Create a new instance of the UpdateFollow Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateFollow(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Follows/UpdateFollow"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateFollowResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateFollowResultSet(result);
	}
