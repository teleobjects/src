...
*/
public class ReadFollows extends Choreography {

	/**
	Create a new instance of the ReadFollows Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadFollows(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Follows/ReadFollows"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadFollowsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadFollowsResultSet(result);
	}
