...
*/
public class DeleteWatch extends Choreography {

	/**
	Create a new instance of the DeleteWatch Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteWatch(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/Watches/DeleteWatch"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteWatchResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteWatchResultSet(result);
	}
