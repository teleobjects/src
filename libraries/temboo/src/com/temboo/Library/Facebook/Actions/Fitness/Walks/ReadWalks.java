...
*/
public class ReadWalks extends Choreography {

	/**
	Create a new instance of the ReadWalks Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadWalks(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Walks/ReadWalks"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadWalksResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadWalksResultSet(result);
	}
