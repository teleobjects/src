...
*/
public class CreateWantsToRead extends Choreography {

	/**
	Create a new instance of the CreateWantsToRead Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateWantsToRead(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/WantsToRead/CreateWantsToRead"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateWantsToReadResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateWantsToReadResultSet(result);
	}
