...
*/
public class ReadRatings extends Choreography {

	/**
	Create a new instance of the ReadRatings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadRatings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Video/Rates/ReadRatings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadRatingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadRatingsResultSet(result);
	}
