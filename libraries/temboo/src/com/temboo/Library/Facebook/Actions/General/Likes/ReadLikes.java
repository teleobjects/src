...
*/
public class ReadLikes extends Choreography {

	/**
	Create a new instance of the ReadLikes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadLikes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Likes/ReadLikes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadLikesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadLikesResultSet(result);
	}
