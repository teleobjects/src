...
*/
public class DeleteWalk extends Choreography {

	/**
	Create a new instance of the DeleteWalk Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteWalk(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Walks/DeleteWalk"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteWalkResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteWalkResultSet(result);
	}
