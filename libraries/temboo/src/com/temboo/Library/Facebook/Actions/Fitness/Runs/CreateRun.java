...
*/
public class CreateRun extends Choreography {

	/**
	Create a new instance of the CreateRun Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateRun(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Runs/CreateRun"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateRunResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateRunResultSet(result);
	}
