...
*/
public class UpdateBike extends Choreography {

	/**
	Create a new instance of the UpdateBike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateBike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Bikes/UpdateBike"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateBikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateBikeResultSet(result);
	}
