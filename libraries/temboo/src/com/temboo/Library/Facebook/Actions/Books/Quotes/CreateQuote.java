...
*/
public class CreateQuote extends Choreography {

	/**
	Create a new instance of the CreateQuote Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateQuote(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Quotes/CreateQuote"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateQuoteResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateQuoteResultSet(result);
	}
