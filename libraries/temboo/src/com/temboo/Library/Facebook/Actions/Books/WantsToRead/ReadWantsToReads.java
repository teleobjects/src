...
*/
public class ReadWantsToReads extends Choreography {

	/**
	Create a new instance of the ReadWantsToReads Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadWantsToReads(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/WantsToRead/ReadWantsToReads"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadWantsToReadsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadWantsToReadsResultSet(result);
	}
