...
*/
public class ReadQuotes extends Choreography {

	/**
	Create a new instance of the ReadQuotes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadQuotes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Quotes/ReadQuotes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadQuotesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadQuotesResultSet(result);
	}
