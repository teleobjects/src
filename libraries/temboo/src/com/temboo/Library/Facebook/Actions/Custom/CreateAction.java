...
*/
public class CreateAction extends Choreography {

	/**
	Create a new instance of the CreateAction Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateAction(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Custom/CreateAction"));
	}
	...
	*/
	public void setActionType(String value) {
		this.inputs.setInput("ActionType", value);
	}
	...
	*/
	public void setAppNamespace(String value) {
		this.inputs.setInput("AppNamespace", value);
	}
	...
	*/
	public void setPropertyValue(String value) {
		this.inputs.setInput("PropertyValue", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateActionResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateActionResultSet(result);
	}
