...
public class DeleteAction extends Choreography {
	...
	*/
	public DeleteAction(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Custom/DeleteAction"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteActionResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteActionResultSet(result);
	}
