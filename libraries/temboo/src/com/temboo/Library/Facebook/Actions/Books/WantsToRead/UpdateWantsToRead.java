...
*/
public class UpdateWantsToRead extends Choreography {

	/**
	Create a new instance of the UpdateWantsToRead Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateWantsToRead(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/WantsToRead/UpdateWantsToRead"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateWantsToReadResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateWantsToReadResultSet(result);
	}
