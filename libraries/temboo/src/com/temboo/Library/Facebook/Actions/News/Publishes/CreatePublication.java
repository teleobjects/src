...
*/
public class CreatePublication extends Choreography {

	/**
	Create a new instance of the CreatePublication Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreatePublication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/News/Publishes/CreatePublication"));
	}
	...
	*/
	public void setArticle(String value) {
		this.inputs.setInput("Article", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreatePublicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreatePublicationResultSet(result);
	}
