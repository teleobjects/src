...
*/
public class ReadRuns extends Choreography {

	/**
	Create a new instance of the ReadRuns Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadRuns(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Runs/ReadRuns"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadRunsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadRunsResultSet(result);
	}
