...
*/
public class DeleteLike extends Choreography {

	/**
	Create a new instance of the DeleteLike Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteLike(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Likes/DeleteLike"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteLikeResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteLikeResultSet(result);
	}
