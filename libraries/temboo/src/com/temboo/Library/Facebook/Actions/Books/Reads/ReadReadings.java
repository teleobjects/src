...
public class ReadReadings extends Choreography {
	...
	*/
	public ReadReadings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Reads/ReadReadings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadReadingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadReadingsResultSet(result);
	}
