...
*/
public class DeleteQuote extends Choreography {

	/**
	Create a new instance of the DeleteQuote Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteQuote(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Quotes/DeleteQuote"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteQuoteResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteQuoteResultSet(result);
	}
