...
*/
public class DeleteRun extends Choreography {

	/**
	Create a new instance of the DeleteRun Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRun(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Runs/DeleteRun"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRunResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRunResultSet(result);
	}
