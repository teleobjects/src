...
public class DeleteWantsToRead extends Choreography {
	...
	*/
	public DeleteWantsToRead(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/WantsToRead/DeleteWantsToRead"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteWantsToReadResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteWantsToReadResultSet(result);
	}
