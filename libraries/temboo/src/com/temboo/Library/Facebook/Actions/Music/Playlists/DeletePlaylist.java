...
*/
public class DeletePlaylist extends Choreography {

	/**
	Create a new instance of the DeletePlaylist Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeletePlaylist(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Music/Playlists/DeletePlaylist"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeletePlaylistResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeletePlaylistResultSet(result);
	}
