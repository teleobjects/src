...
*/
public class ReadBikes extends Choreography {

	/**
	Create a new instance of the ReadBikes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadBikes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Bikes/ReadBikes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadBikesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadBikesResultSet(result);
	}
