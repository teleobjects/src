...
*/
public class UpdateRun extends Choreography {

	/**
	Create a new instance of the UpdateRun Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateRun(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Fitness/Runs/UpdateRun"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateRunResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateRunResultSet(result);
	}
