...
*/
public class UpdateQuote extends Choreography {

	/**
	Create a new instance of the UpdateQuote Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateQuote(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Quotes/UpdateQuote"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateQuoteResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateQuoteResultSet(result);
	}
