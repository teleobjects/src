...
*/
public class DeletePublication extends Choreography {

	/**
	Create a new instance of the DeletePublication Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeletePublication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/News/Publishes/DeletePublication"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeletePublicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeletePublicationResultSet(result);
	}
