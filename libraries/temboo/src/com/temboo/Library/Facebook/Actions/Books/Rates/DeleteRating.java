...
*/
public class DeleteRating extends Choreography {

	/**
	Create a new instance of the DeleteRating Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRating(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/Books/Rates/DeleteRating"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteRatingResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRatingResultSet(result);
	}
