...
*/
public class Series extends Choreography {

	/**
	Create a new instance of the Series Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Series(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NPR/StoryFinder/Series"));
	}
	...
	*/
	public void setSeries(String value) {
		this.inputs.setInput("Series", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public SeriesResultSet run() {
		JSONObject result = super.runWithResults();
		return new SeriesResultSet(result);
	}
