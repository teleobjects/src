...
*/
public class MusicArtists extends Choreography {

	/**
	Create a new instance of the MusicArtists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MusicArtists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NPR/StoryFinder/MusicArtists"));
	}
	...
	*/
	public void setMusicArtist(String value) {
		this.inputs.setInput("MusicArtist", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public MusicArtistsResultSet run() {
		JSONObject result = super.runWithResults();
		return new MusicArtistsResultSet(result);
	}
