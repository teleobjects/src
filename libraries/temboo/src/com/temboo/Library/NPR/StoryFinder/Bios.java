...
*/
public class Bios extends Choreography {

	/**
	Create a new instance of the Bios Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Bios(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NPR/StoryFinder/Bios"));
	}
	...
	*/
	public void setPersonality(String value) {
		this.inputs.setInput("Personality", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public BiosResultSet run() {
		JSONObject result = super.runWithResults();
		return new BiosResultSet(result);
	}
