...
*/
public class Topics extends Choreography {

	/**
	Create a new instance of the Topics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Topics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/NPR/StoryFinder/Topics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TopicsResultSet run() {
		JSONObject result = super.runWithResults();
		return new TopicsResultSet(result);
	}
