...
*/
public class SearchTags extends Choreography {

	/**
	Create a new instance of the SearchTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SearchTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/SearchTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchTagsResultSet(result);
	}
