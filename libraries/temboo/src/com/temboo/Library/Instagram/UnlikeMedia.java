...
*/
public class UnlikeMedia extends Choreography {

	/**
	Create a new instance of the UnlikeMedia Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UnlikeMedia(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/UnlikeMedia"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UnlikeMediaResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnlikeMediaResultSet(result);
	}
