...
*/
public class GetRelationship extends Choreography {

	/**
	Create a new instance of the GetRelationship Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRelationship(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetRelationship"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRelationshipResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRelationshipResultSet(result);
	}
