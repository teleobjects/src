...
public class GetFollowerRequests extends Choreography {
	...
	*/
	public GetFollowerRequests(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetFollowerRequests"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFollowerRequestsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFollowerRequestsResultSet(result);
	}
