...
*/
public class GetMediaByID extends Choreography {

	/**
	Create a new instance of the GetMediaByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMediaByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetMediaByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMediaByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMediaByIDResultSet(result);
	}
