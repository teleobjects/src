...
*/
public class GetMediaComments extends Choreography {

	/**
	Create a new instance of the GetMediaComments Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMediaComments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetMediaComments"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMediaCommentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMediaCommentsResultSet(result);
	}
