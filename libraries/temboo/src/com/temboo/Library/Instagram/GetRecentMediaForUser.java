...
*/
public class GetRecentMediaForUser extends Choreography {

	/**
	Create a new instance of the GetRecentMediaForUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRecentMediaForUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetRecentMediaForUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRecentMediaForUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecentMediaForUserResultSet(result);
	}
