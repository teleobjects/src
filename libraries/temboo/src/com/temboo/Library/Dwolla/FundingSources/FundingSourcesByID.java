...
public class FundingSourcesByID extends Choreography {
	...
	*/
	public FundingSourcesByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dwolla/FundingSources/FundingSourcesByID"));
	}
	...
	*/
	public void setFundingID(String value) {
		this.inputs.setInput("FundingID", value);
	}
	 ...
	 */
	@Override
	public FundingSourcesByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new FundingSourcesByIDResultSet(result);
	}
