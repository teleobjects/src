...
*/
public class GetCustomerPaymentProfile extends Choreography {

	/**
	Create a new instance of the GetCustomerPaymentProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCustomerPaymentProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/AuthorizeNet/CustomerInformationManager/GetCustomerPaymentProfile"));
	}
	...
	*/
	public void setCustomerPaymentProfileId(Integer value) {
		this.inputs.setInput("CustomerPaymentProfileId", value);
	}

	/** 
	Set the value of the CustomerPaymentProfileId input for this Choreo as a String. 

	@param String - (required, integer) The id for the payment profile you want to retrieve.
	*/
	...
	*/
	...
	@param String - (required, integer) The id of the customer who's payment profile you want to return.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetCustomerPaymentProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCustomerPaymentProfileResultSet(result);
	}
