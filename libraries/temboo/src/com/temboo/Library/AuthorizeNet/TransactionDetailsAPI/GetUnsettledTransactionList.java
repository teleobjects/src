...
*/
public class GetUnsettledTransactionList extends Choreography {

	/**
	Create a new instance of the GetUnsettledTransactionList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUnsettledTransactionList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/AuthorizeNet/TransactionDetailsAPI/GetUnsettledTransactionList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUnsettledTransactionListResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUnsettledTransactionListResultSet(result);
	}
