...
*/
public class GetBatchStatistics extends Choreography {

	/**
	Create a new instance of the GetBatchStatistics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBatchStatistics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/AuthorizeNet/TransactionDetailsAPI/GetBatchStatistics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBatchStatisticsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBatchStatisticsResultSet(result);
	}
