...
*/
public class UncompleteItem extends Choreography {

	/**
	Create a new instance of the UncompleteItem Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UncompleteItem(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/UncompleteItem"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UncompleteItemResultSet run() {
		JSONObject result = super.runWithResults();
		return new UncompleteItemResultSet(result);
	}
