...
*/
public class GetProject extends Choreography {

	/**
	Create a new instance of the GetProject Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetProject(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetProject"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project you want to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetProjectResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetProjectResultSet(result);
	}
