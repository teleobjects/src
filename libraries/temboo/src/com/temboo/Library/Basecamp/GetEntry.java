...
*/
public class GetEntry extends Choreography {

	/**
	Create a new instance of the GetEntry Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEntry(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetEntry"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the calendar entry to retrieve.
	*/
	...
	*/
	...
	@param String - (required, integer) The ID for the project from which to retrieve the calendar entry.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetEntryResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEntryResultSet(result);
	}
