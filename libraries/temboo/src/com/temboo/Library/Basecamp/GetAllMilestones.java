...
*/
public class GetAllMilestones extends Choreography {

	/**
	Create a new instance of the GetAllMilestones Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllMilestones(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetAllMilestones"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project from which to retrieve all milestones.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetAllMilestonesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllMilestonesResultSet(result);
	}
