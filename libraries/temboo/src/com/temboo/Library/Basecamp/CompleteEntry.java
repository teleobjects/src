...
*/
public class CompleteEntry extends Choreography {

	/**
	Create a new instance of the CompleteEntry Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CompleteEntry(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/CompleteEntry"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the calendar entry to mark as completed.
	*/
	...
	*/
	...
	@param String - (required, integer) The ID for the project with the calendar entry to mark as completed.
	*/
	...
	*/
	 ...
	 */
	@Override
	public CompleteEntryResultSet run() {
		JSONObject result = super.runWithResults();
		return new CompleteEntryResultSet(result);
	}
