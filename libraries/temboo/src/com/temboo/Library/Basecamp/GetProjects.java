...
*/
public class GetProjects extends Choreography {

	/**
	Create a new instance of the GetProjects Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetProjects(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetProjects"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetProjectsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetProjectsResultSet(result);
	}
