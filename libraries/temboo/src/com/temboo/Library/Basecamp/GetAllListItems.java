...
*/
public class GetAllListItems extends Choreography {

	/**
	Create a new instance of the GetAllListItems Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllListItems(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetAllListItems"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID of the list for which you're returning items.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetAllListItemsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllListItemsResultSet(result);
	}
