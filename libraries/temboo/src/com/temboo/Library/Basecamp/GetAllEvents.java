...
public class GetAllEvents extends Choreography {
	...
	*/
	public GetAllEvents(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetAllEvents"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project from which to retrieve all calendar events.
	*/
