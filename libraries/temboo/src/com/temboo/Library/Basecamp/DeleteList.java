...
*/
public class DeleteList extends Choreography {

	/**
	Create a new instance of the DeleteList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/DeleteList"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the To-Do list to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteListResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteListResultSet(result);
	}
