...
*/
public class GetPeopleWithinProject extends Choreography {

	/**
	Create a new instance of the GetPeopleWithinProject Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPeopleWithinProject(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetPeopleWithinProject"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project associated with the people you want to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetPeopleWithinProjectResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPeopleWithinProjectResultSet(result);
	}
