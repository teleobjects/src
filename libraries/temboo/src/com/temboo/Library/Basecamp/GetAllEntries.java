...
*/
public class GetAllEntries extends Choreography {

	/**
	Create a new instance of the GetAllEntries Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllEntries(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetAllEntries"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project from which to retrieve all calendar entries.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetAllEntriesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllEntriesResultSet(result);
	}
