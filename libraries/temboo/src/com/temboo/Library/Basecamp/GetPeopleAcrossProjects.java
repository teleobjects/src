...
*/
public class GetPeopleAcrossProjects extends Choreography {

	/**
	Create a new instance of the GetPeopleAcrossProjects Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPeopleAcrossProjects(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetPeopleAcrossProjects"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPeopleAcrossProjectsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPeopleAcrossProjectsResultSet(result);
	}
