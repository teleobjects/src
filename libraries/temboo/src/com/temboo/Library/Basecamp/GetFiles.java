...
*/
public class GetFiles extends Choreography {

	/**
	Create a new instance of the GetFiles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFiles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Basecamp/GetFiles"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID for the project that contains the attachments to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetFilesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFilesResultSet(result);
	}
