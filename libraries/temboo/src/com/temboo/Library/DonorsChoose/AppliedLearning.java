...
*/
public class AppliedLearning extends Choreography {

	/**
	Create a new instance of the AppliedLearning Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AppliedLearning(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/DonorsChoose/AppliedLearning"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AppliedLearningResultSet run() {
		JSONObject result = super.runWithResults();
		return new AppliedLearningResultSet(result);
	}
