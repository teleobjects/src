...
*/
public class LiteracyAndLanguage extends Choreography {

	/**
	Create a new instance of the LiteracyAndLanguage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LiteracyAndLanguage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/DonorsChoose/LiteracyAndLanguage"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LiteracyAndLanguageResultSet run() {
		JSONObject result = super.runWithResults();
		return new LiteracyAndLanguageResultSet(result);
	}
