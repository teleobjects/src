...
*/
public class HistoryAndCivics extends Choreography {

	/**
	Create a new instance of the HistoryAndCivics Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public HistoryAndCivics(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/DonorsChoose/HistoryAndCivics"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HistoryAndCivicsResultSet run() {
		JSONObject result = super.runWithResults();
		return new HistoryAndCivicsResultSet(result);
	}
