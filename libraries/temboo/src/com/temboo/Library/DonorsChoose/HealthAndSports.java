...
*/
public class HealthAndSports extends Choreography {

	/**
	Create a new instance of the HealthAndSports Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public HealthAndSports(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/DonorsChoose/HealthAndSports"));
	}
	...
	*/
	 ...
	 */
	@Override
	public HealthAndSportsResultSet run() {
		JSONObject result = super.runWithResults();
		return new HealthAndSportsResultSet(result);
	}
