...
*/
public class GetUsers extends Choreography {

	/**
	Create a new instance of the GetUsers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUsers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CloudMine/UserAccountManagement/GetUsers"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUsersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUsersResultSet(result);
	}
