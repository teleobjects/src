...
*/
public class ObjectSet extends Choreography {

	/**
	Create a new instance of the ObjectSet Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ObjectSet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/CloudMine/ObjectStorage/ObjectSet"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ObjectSetResultSet run() {
		JSONObject result = super.runWithResults();
		return new ObjectSetResultSet(result);
	}
