package com.temboo.Library.Kiva.Partners;
...
*/
public class GetPartners extends Choreography {

	/**
	Create a new instance of the GetPartners Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPartners(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Partners/GetPartners"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPartnersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPartnersResultSet(result);
	}
