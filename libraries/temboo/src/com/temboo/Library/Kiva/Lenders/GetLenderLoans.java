...
*/
public class GetLenderLoans extends Choreography {

	/**
	Create a new instance of the GetLenderLoans Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLenderLoans(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Lenders/GetLenderLoans"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLenderLoansResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLenderLoansResultSet(result);
	}
