...
*/
public class GetLenderTeams extends Choreography {

	/**
	Create a new instance of the GetLenderTeams Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLenderTeams(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Lenders/GetLenderTeams"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLenderTeamsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLenderTeamsResultSet(result);
	}
