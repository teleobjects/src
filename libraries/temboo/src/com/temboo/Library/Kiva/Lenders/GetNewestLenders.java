...
*/
public class GetNewestLenders extends Choreography {

	/**
	Create a new instance of the GetNewestLenders Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetNewestLenders(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Lenders/GetNewestLenders"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetNewestLendersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetNewestLendersResultSet(result);
	}
