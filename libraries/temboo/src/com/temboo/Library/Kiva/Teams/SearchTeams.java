...
public class SearchTeams extends Choreography {
	...
	*/
	public SearchTeams(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Teams/SearchTeams"));
	}
	...
	*/
	public void setMembershipType(String value) {
		this.inputs.setInput("MembershipType", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchTeamsResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchTeamsResultSet(result);
	}
