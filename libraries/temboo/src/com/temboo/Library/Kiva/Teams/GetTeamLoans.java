...
*/
public class GetTeamLoans extends Choreography {

	/**
	Create a new instance of the GetTeamLoans Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTeamLoans(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Kiva/Teams/GetTeamLoans"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTeamLoansResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTeamLoansResultSet(result);
	}
