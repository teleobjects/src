...
*/
public class GetTranslations extends Choreography {

	/**
	Create a new instance of the GetTranslations Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTranslations(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Translator/GetTranslations"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTranslationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTranslationsResultSet(result);
	}
