...
*/
public class GetLanguagesForTranslate extends Choreography {

	/**
	Create a new instance of the GetLanguagesForTranslate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLanguagesForTranslate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Translator/GetLanguagesForTranslate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLanguagesForTranslateResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLanguagesForTranslateResultSet(result);
	}
