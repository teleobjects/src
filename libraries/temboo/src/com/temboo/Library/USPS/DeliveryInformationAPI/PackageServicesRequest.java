...
*/
public class PackageServicesRequest extends Choreography {

	/**
	Create a new instance of the PackageServicesRequest Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PackageServicesRequest(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/USPS/DeliveryInformationAPI/PackageServicesRequest"));
	}
	...
	*/
	...
	@param String - (required, integer) First 3 digits of a 5-digit zip code.  Required value.
	*/
	...
	*/
	 ...
	 */
	@Override
	public PackageServicesRequestResultSet run() {
		JSONObject result = super.runWithResults();
		return new PackageServicesRequestResultSet(result);
	}
