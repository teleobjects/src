...
#else
  // SPI.setClockDivider(1); // 16.8MHz on Due
...
/// Set row color in the gradient map
void OLED::setGradient(const byte y, const OLED_Colour colour) {
  this->gradient[y] = colour;
}
